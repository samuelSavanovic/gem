...
#line 520 "compiler/main.gem"
    GemVal _t1301[] = {(*gem_v_defined_fns), gem_v_name};
                                                                    if (gem_truthy(gem_fn_set_contains(NULL, _t1301, 2))) {
#line 521 "compiler/main.gem"
    GemVal _t1302 = gem_table_new();
    GemVal _t1303[] = {gem_v_name};
    gem_table_set(_t1302, gem_string("expr"), gem_add(gem_add(gem_string("gem_make_fn(gem_fn_"), gem_to_string_fn(NULL, _t1303, 1)), gem_string(", NULL)")));
...
#line 523 "compiler/main.gem"
    GemVal _t1305 = (*gem_v_mangle);
    GemVal _t1306[] = {gem_v_name};
                                GemVal gem_v_mname = _t1305.fn(_t1305.env, _t1306, 1);
#line 524 "compiler/main.gem"
    GemVal _t1307[] = {(*gem_v_boxed_vars), gem_v_name};
                                if (gem_truthy(gem_fn_set_contains(NULL, _t1307, 2))) {
#line 525 "compiler/main.gem"
    GemVal _t1308 = gem_table_new();
    GemVal _t1309[] = {gem_v_mname};
    gem_table_set(_t1308, gem_string("expr"), gem_add(gem_add(gem_string("(*"), gem_to_string_fn(NULL, _t1309, 1)), gem_string(")")));
...
#line 527 "compiler/main.gem"
    ...
    gem_table_set(_t1311, gem_string("expr"), gem_v_mname);
...
#line 529 "compiler/main.gem"
    GemVal _t1313 = (*gem_v_compile_call);
    GemVal _t1314[] = {gem_v_node};
                                    GemVal _t1315 = _t1313.fn(_t1313.env, _t1314, 1);
                                    gem_pop_frame();
                                    return _t1315;
                                } else {
#line 530 "compiler/main.gem"
...
#line 531 "compiler/main.gem"
    GemVal _t1316 = (*gem_v_compile_binop);
    GemVal _t1317[] = {gem_v_node};
                                        GemVal _t1318 = _t1316.fn(_t1316.env, _t1317, 1);
                                        gem_pop_frame();
                                        return _t1318;
                                    } else {
...
#line 533 "compiler/main.gem"
    ...
    GemVal _t1320 = (*gem_v_compile_expr);
    GemVal _t1321[] = {gem_table_get(_t1319, gem_string("expr"))};
                                            GemVal gem_v_r = _t1320.fn(_t1320.env, _t1321, 1);
#line 534 "compiler/main.gem"
    GemVal _t1322 = gem_v_node;
                                            if (gem_truthy(gem_eq(gem_table_get(_t1322, gem_string("op")), gem_string("-")))) {
#line 535 "compiler/main.gem"
    ...
    gem_table_set(_t1323, gem_string("expr"), gem_add(gem_add(gem_string("gem_neg("), gem_to_string_fn(NULL, _t1325, 1)), gem_string(")")));
...
#line 536 "compiler/main.gem"
    GemVal _t1328 = gem_v_node;
                                                if (gem_truthy(gem_eq(gem_table_get(_t1328, gem_string("op")), gem_string("not")))) {
#line 537 "compiler/main.gem"
    ...
    gem_table_set(_t1329, gem_string("expr"), gem_add(gem_add(gem_string("gem_not("), gem_to_string_fn(NULL, _t1331, 1)), gem_string(")")));
...
#line 540 "compiler/main.gem"
    GemVal _t1334 = (*gem_v_compile_anon_fn);
...
#line 542 "compiler/main.gem"
    GemVal _t1337 = (*gem_v_compile_table);
...
#line 544 "compiler/main.gem"
    GemVal _t1340 = (*gem_v_compile_array);
...
#line 546 "compiler/main.gem"
    ...
    GemVal _t1345[] = {gem_table_get(_t1343, gem_string("object"))};
                                                            GemVal gem_v_r = _t1344.fn(_t1344.env, _t1345, 1);
#line 547 "compiler/main.gem"
    GemVal _t1346 = (*gem_v_tmp);
                                                            GemVal gem_v_t = _t1346.fn(_t1346.env, NULL, 0);
#line 548 "compiler/main.gem"
    GemVal _t1347 = gem_v_r;
    GemVal _t1348[] = {gem_v_t};
    GemVal _t1349 = gem_v_r;
    GemVal _t1350[] = {gem_table_get(_t1349, gem_string("expr"))};
                                                            GemVal gem_v_setup = gem_add(gem_table_get(_t1347, gem_string("setup")), gem_add(gem_add(gem_add(gem_add(gem_string("    GemVal "), gem_to_string_fn(NULL, _t1348, 1)), gem_string(" = ")), gem_to_string_fn(NULL, _t1350, 1)), gem_string(";\n")));
#line 549 "compiler/main.gem"
    GemVal _t1351 = gem_v_node;
    GemVal _t1352[] = {gem_table_get(_t1351, gem_string("field"))};
                                                            GemVal gem_v_escaped = gem_fn_escape_c_string(NULL, _t1352, 1);
#line 550 "compiler/main.gem"
    GemVal _t1353 = gem_table_new();
    GemVal _t1354[] = {gem_v_t};
    GemVal _t1355[] = {gem_v_escaped};
    gem_table_set(_t1353, gem_string("expr"), gem_add(gem_add(gem_add(gem_add(gem_string("gem_table_get("), gem_to_string_fn(NULL, _t1354, 1)), gem_string(", gem_string(\"")), gem_to_string_fn(NULL, _t1355, 1)), gem_string("\"))")));
    gem_table_set(_t1353, gem_string("setup"), gem_v_setup);
                                                            GemVal _t1356 = _t1353;
                                                            gem_pop_frame();
                                                            return _t1356;
                                                        } else {
#line 551 "compiler/main.gem"
...
#line 552 "compiler/main.gem"
    ...
    GemVal _t1359[] = {gem_table_get(_t1357, gem_string("object"))};
                                                                GemVal gem_v_obj_r = _t1358.fn(_t1358.env, _t1359, 1);
#line 553 "compiler/main.gem"
    GemVal _t1360 = gem_v_node;
    GemVal _t1361 = (*gem_v_compile_expr);
    GemVal _t1362[] = {gem_table_get(_t1360, gem_string("key"))};
                                                                GemVal gem_v_key_r = _t1361.fn(_t1361.env, _t1362, 1);
#line 554 "compiler/main.gem"
    GemVal _t1363 = gem_table_new();
    GemVal _t1364 = gem_v_obj_r;
    GemVal _t1365[] = {gem_table_get(_t1364, gem_string("expr"))};
    GemVal _t1366 = gem_v_key_r;
    GemVal _t1367[] = {gem_table_get(_t1366, gem_string("expr"))};
    gem_table_set(_t1363, gem_string("expr"), gem_add(gem_add(gem_add(gem_add(gem_string("gem_table_get("), gem_to_string_fn(NULL, _t1365, 1)), gem_string(", ")), gem_to_string_fn(NULL, _t1367, 1)), gem_string(")")));
    GemVal _t1368 = gem_v_obj_r;
    GemVal _t1369 = gem_v_key_r;
    gem_table_set(_t1363, gem_string("setup"), gem_add(gem_table_get(_t1368, gem_string("setup")), gem_table_get(_t1369, gem_string("setup"))));
                                                                GemVal _t1370 = _t1363;
                                                                gem_pop_frame();
                                                                return _t1370;
                                                            }
                                                        }
    ...
    gem_table_set(_t1371, gem_string("expr"), gem_string("GEM_NIL"));
    gem_table_set(_t1371, gem_string("setup"), gem_add(gem_add(gem_string("/* unknown node: "), gem_v_tag), gem_string(" */\n")));
    GemVal _t1372 = _t1371;
    gem_pop_frame();
    return _t1372;
}
...
#line 563 "compiler/main.gem"
    ...
    GemVal gem_v_entries = gem_table_get(_t1374, gem_string("entries"));
#line 564 "compiler/main.gem"
    GemVal _t1375 = (*gem_v_tmp);
    GemVal gem_v_t = _t1375.fn(_t1375.env, NULL, 0);
#line 565 "compiler/main.gem"
    GemVal _t1376[] = {gem_v_t};
    GemVal gem_v_setup = gem_add(gem_add(gem_string("    GemVal "), gem_to_string_fn(NULL, _t1376, 1)), gem_string(" = gem_table_new();\n"));
    {
...
#line 566 "compiler/main.gem"
        while (1) {
            GemVal _t1377[] = {gem_v__for_items_21};
            if (!gem_truthy(gem_lt(gem_v__for_i_21, gem_len_fn(NULL, _t1377, 1)))) break;
#line 566 "compiler/main.gem"
            GemVal gem_v_entry = gem_table_get(gem_v__for_items_21, gem_v__for_i_21);
#line 566 "compiler/main.gem"
            gem_v__for_i_21 = gem_add(gem_v__for_i_21, gem_int(1));
#line 567 "compiler/main.gem"
    GemVal _t1378 = gem_v_entry;
    GemVal _t1379 = (*gem_v_compile_expr);
    GemVal _t1380[] = {gem_table_get(_t1378, gem_string("value"))};
            GemVal gem_v_val_r = _t1379.fn(_t1379.env, _t1380, 1);
#line 568 "compiler/main.gem"
    GemVal _t1381 = gem_v_entry;
    GemVal _t1382[] = {gem_table_get(_t1381, gem_string("key"))};
            GemVal gem_v_escaped = gem_fn_escape_c_string(NULL, _t1382, 1);
#line 569 "compiler/main.gem"
    GemVal _t1383 = gem_v_val_r;
            gem_v_setup = gem_add(gem_v_setup, gem_table_get(_t1383, gem_string("setup")));
#line 570 "compiler/main.gem"
    GemVal _t1384[] = {gem_v_t};
    GemVal _t1385[] = {gem_v_escaped};
    GemVal _t1386 = gem_v_val_r;
    GemVal _t1387[] = {gem_table_get(_t1386, gem_string("expr"))};
            gem_v_setup = gem_add(gem_v_setup, gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_string("    gem_table_set("), gem_to_string_fn(NULL, _t1384, 1)), gem_string(", gem_string(\"")), gem_to_string_fn(NULL, _t1385, 1)), gem_string("\"), ")), gem_to_string_fn(NULL, _t1387, 1)), gem_string(");\n")));
        }
    }
    GemVal _t1388 = gem_table_new();
    gem_table_set(_t1388, gem_string("expr"), gem_v_t);
    gem_table_set(_t1388, gem_string("setup"), gem_v_setup);
...
#line 578 "compiler/main.gem"
    ...
    GemVal gem_v_elements = gem_table_get(_t1391, gem_string("elements"));
#line 579 "compiler/main.gem"
...
#line 581 "compiler/main.gem"
    GemVal _t1394[] = {gem_v_elements};
        GemVal gem_v__for_limit_22 = gem_len_fn(NULL, _t1394, 1);
#line 581 "compiler/main.gem"
        while (1) {
...
#line 582 "compiler/main.gem"
    ...
    GemVal _t1396[] = {gem_table_get(gem_v_elements, gem_v_i)};
            GemVal gem_v_elem_r = _t1395.fn(_t1395.env, _t1396, 1);
#line 583 "compiler/main.gem"
    GemVal _t1397 = gem_v_elem_r;
            gem_v_setup = gem_add(gem_v_setup, gem_table_get(_t1397, gem_string("setup")));
#line 584 "compiler/main.gem"
    GemVal _t1398[] = {gem_v_t};
    GemVal _t1399[] = {gem_v_i};
    GemVal _t1400 = gem_v_elem_r;
    GemVal _t1401[] = {gem_table_get(_t1400, gem_string("expr"))};
            gem_v_setup = gem_add(gem_v_setup, gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_string("    gem_table_set("), gem_to_string_fn(NULL, _t1398, 1)), gem_string(", gem_int(")), gem_to_string_fn(NULL, _t1399, 1)), gem_string("), ")), gem_to_string_fn(NULL, _t1401, 1)), gem_string(");\n")));
        }
    }
...
#line 592 "compiler/main.gem"
    ...
    GemVal _t1406[] = {gem_table_get(_t1405, gem_string("params"))};
    GemVal gem_v_inner_defined = gem_fn_sorted_array_to_set(NULL, _t1406, 1);
#line 593 "compiler/main.gem"
    GemVal _t1407 = gem_v_node;
    GemVal _t1408 = (*gem_v_collect_free_vars);
    GemVal _t1409[] = {gem_table_get(_t1407, gem_string("body")), gem_v_inner_defined};
    GemVal gem_v_free = _t1408.fn(_t1408.env, _t1409, 2);
#line 594 "compiler/main.gem"
    GemVal _t1410[] = {gem_v_free};
    GemVal gem_v_captures = gem_fn_set_to_sorted_array(NULL, _t1410, 1);
#line 596 "compiler/main.gem"
    GemVal _t1411[] = {gem_v_captures};
    if (gem_truthy(gem_eq(gem_len_fn(NULL, _t1411, 1), gem_int(0)))) {
#line 597 "compiler/main.gem"
    GemVal _t1412 = gem_table_new();
    GemVal _t1413 = (*gem_v_compile_closure_fn);
    GemVal _t1414[] = {gem_v_node, _t1412};
        GemVal gem_v_result = _t1413.fn(_t1413.env, _t1414, 2);
#line 598 "compiler/main.gem"
    GemVal _t1415 = gem_table_new();
    GemVal _t1416 = gem_v_result;
    GemVal _t1417[] = {gem_table_get(_t1416, gem_string("fn_name"))};
    gem_table_set(_t1415, gem_string("expr"), gem_add(gem_add(gem_string("gem_make_fn("), gem_to_string_fn(NULL, _t1417, 1)), gem_string(", NULL)")));
    gem_table_set(_t1415, gem_string("setup"), gem_string(""));
        GemVal _t1418 = _t1415;
        gem_pop_frame();
        return _t1418;
    }
#line 601 "compiler/main.gem"
    GemVal _t1419 = (*gem_v_compile_closure_fn);
    GemVal _t1420[] = {gem_v_node, gem_v_captures};
    GemVal gem_v_result = _t1419.fn(_t1419.env, _t1420, 2);
#line 603 "compiler/main.gem"
    GemVal gem_v_setup = gem_string("");
#line 604 "compiler/main.gem"
    GemVal _t1421 = (*gem_v_tmp);
    GemVal gem_v_env_tmp = _t1421.fn(_t1421.env, NULL, 0);
#line 605 "compiler/main.gem"
    GemVal _t1422 = gem_v_result;
    GemVal _t1423[] = {gem_table_get(_t1422, gem_string("struct_name"))};
    GemVal _t1424[] = {gem_v_env_tmp};
    GemVal _t1425 = gem_v_result;
    GemVal _t1426[] = {gem_table_get(_t1425, gem_string("struct_name"))};
    gem_v_setup = gem_add(gem_v_setup, gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_string("    struct "), gem_to_string_fn(NULL, _t1423, 1)), gem_string(" *")), gem_to_string_fn(NULL, _t1424, 1)), gem_string(" = GC_MALLOC(sizeof(struct ")), gem_to_string_fn(NULL, _t1426, 1)), gem_string("));\n")));
    {
#line 606 "compiler/main.gem"
...
#line 606 "compiler/main.gem"
        while (1) {
            GemVal _t1427[] = {gem_v__for_items_23};
            if (!gem_truthy(gem_lt(gem_v__for_i_23, gem_len_fn(NULL, _t1427, 1)))) break;
#line 606 "compiler/main.gem"
...
#line 607 "compiler/main.gem"
    ...
    GemVal _t1429[] = {gem_v_cap};
            GemVal gem_v_mc = _t1428.fn(_t1428.env, _t1429, 1);
#line 608 "compiler/main.gem"
    GemVal _t1430[] = {(*gem_v_boxed_vars), gem_v_cap};
            if (gem_truthy(gem_fn_set_contains(NULL, _t1430, 2))) {
#line 609 "compiler/main.gem"
    GemVal _t1431[] = {gem_v_env_tmp};
    GemVal _t1432[] = {gem_v_mc};
    GemVal _t1433[] = {gem_v_mc};
                gem_v_setup = gem_add(gem_v_setup, gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_string("    "), gem_to_string_fn(NULL, _t1431, 1)), gem_string("->")), gem_to_string_fn(NULL, _t1432, 1)), gem_string(" = ")), gem_to_string_fn(NULL, _t1433, 1)), gem_string(";\n")));
            } else {
#line 611 "compiler/main.gem"
    GemVal _t1434[] = {gem_v_env_tmp};
    GemVal _t1435[] = {gem_v_mc};
    GemVal _t1436[] = {gem_v_mc};
                gem_v_setup = gem_add(gem_v_setup, gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_string("    "), gem_to_string_fn(NULL, _t1434, 1)), gem_string("->")), gem_to_string_fn(NULL, _t1435, 1)), gem_string(" = &")), gem_to_string_fn(NULL, _t1436, 1)), gem_string(";\n")));
            }
        }
    }
    GemVal _t1437 = gem_table_new();
    GemVal _t1438 = gem_v_result;
    GemVal _t1439[] = {gem_table_get(_t1438, gem_string("fn_name"))};
    GemVal _t1440[] = {gem_v_env_tmp};
    gem_table_set(_t1437, gem_string("expr"), gem_add(gem_add(gem_add(gem_add(gem_string("gem_make_fn("), gem_to_string_fn(NULL, _t1439, 1)), gem_string(", ")), gem_to_string_fn(NULL, _t1440, 1)), gem_string(")")));
    gem_table_set(_t1437, gem_string("setup"), gem_v_setup);
    GemVal _t1441 = _t1437;
    gem_pop_frame();
    return _t1441;
}
...
#line 620 "compiler/main.gem"
    ...
    GemVal gem_v_func = gem_table_get(_t1443, gem_string("func"));
#line 621 "compiler/main.gem"
    GemVal _t1444 = gem_v_node;
    GemVal gem_v_args = gem_table_get(_t1444, gem_string("args"));
#line 624 "compiler/main.gem"
    GemVal _t1445 = gem_v_func;
    GemVal _t1447;
    if (!gem_truthy(gem_eq(gem_table_get(_t1445, gem_string("tag")), gem_string("dot")))) {
        _t1447 = gem_eq(gem_table_get(_t1445, gem_string("tag")), gem_string("dot"));
    } else {
        GemVal _t1446 = gem_v_func;
        _t1447 = gem_eq(gem_table_get(_t1446, gem_string("field")), gem_string("len"));
    }
    GemVal _t1449;
    if (!gem_truthy(_t1447)) {
        _t1449 = _t1447;
    } else {
        GemVal _t1448[] = {gem_v_args};
        _t1449 = gem_eq(gem_len_fn(NULL, _t1448, 1), gem_int(0));
    }
    if (gem_truthy(_t1449)) {
#line 625 "compiler/main.gem"
    GemVal _t1450 = gem_v_func;
    GemVal _t1451 = (*gem_v_compile_expr);
    GemVal _t1452[] = {gem_table_get(_t1450, gem_string("object"))};
        GemVal gem_v_obj_r = _t1451.fn(_t1451.env, _t1452, 1);
#line 626 "compiler/main.gem"
    GemVal _t1453 = gem_table_new();
    GemVal _t1454 = gem_v_obj_r;
    GemVal _t1455[] = {gem_table_get(_t1454, gem_string("expr"))};
    gem_table_set(_t1453, gem_string("expr"), gem_add(gem_add(gem_string("gem_len_val("), gem_to_string_fn(NULL, _t1455, 1)), gem_string(")")));
    GemVal _t1456 = gem_v_obj_r;
    gem_table_set(_t1453, gem_string("setup"), gem_table_get(_t1456, gem_string("setup")));
        GemVal _t1457 = _t1453;
        gem_pop_frame();
        return _t1457;
    }
#line 630 "compiler/main.gem"
    GemVal _t1458 = gem_v_func;
    if (gem_truthy(gem_eq(gem_table_get(_t1458, gem_string("tag")), gem_string("var")))) {
#line 631 "compiler/main.gem"
    GemVal _t1459 = gem_v_func;
        GemVal gem_v_name = gem_table_get(_t1459, gem_string("name"));
#line 633 "compiler/main.gem"
        if (gem_truthy(gem_eq(gem_v_name, gem_string("error")))) {
#line 634 "compiler/main.gem"
    GemVal _t1460 = gem_v_node;
            GemVal gem_v_line = gem_table_get(_t1460, gem_string("line"));
...
#line 638 "compiler/main.gem"
    GemVal _t1461[] = {(*gem_v_source_name)};
            GemVal gem_v_escaped_file = gem_fn_escape_c_string(NULL, _t1461, 1);
#line 639 "compiler/main.gem"
            GemVal gem_v_arg_setups = gem_string("");
#line 640 "compiler/main.gem"
    GemVal _t1462 = gem_table_new();
            GemVal gem_v_arg_exprs = _t1462;
            {
#line 641 "compiler/main.gem"
                GemVal gem_v__for_i_24 = gem_int(0);
#line 641 "compiler/main.gem"
    GemVal _t1463[] = {gem_v_args};
                GemVal gem_v__for_limit_24 = gem_len_fn(NULL, _t1463, 1);
#line 641 "compiler/main.gem"
                while (1) {
...
#line 642 "compiler/main.gem"
    GemVal _t1464 = (*gem_v_compile_expr);
    GemVal _t1465[] = {gem_table_get(gem_v_args, gem_v_i)};
                    GemVal gem_v_r = _t1464.fn(_t1464.env, _t1465, 1);
#line 643 "compiler/main.gem"
    GemVal _t1466 = gem_v_r;
                    gem_v_arg_setups = gem_add(gem_v_arg_setups, gem_table_get(_t1466, gem_string("setup")));
#line 644 "compiler/main.gem"
    GemVal _t1467 = gem_v_r;
    GemVal _t1468[] = {gem_v_arg_exprs, gem_table_get(_t1467, gem_string("expr"))};
                    (void)(gem_push_fn(NULL, _t1468, 2));
                }
            }
#line 646 "compiler/main.gem"
    GemVal _t1469[] = {gem_v_args};
            GemVal gem_v_argc = gem_len_fn(NULL, _t1469, 1);
#line 647 "compiler/main.gem"
...
#line 648 "compiler/main.gem"
    ...
    gem_table_set(_t1470, gem_string("expr"), gem_add(gem_add(gem_add(gem_add(gem_string("gem_error_at_fn(\""), gem_to_string_fn(NULL, _t1471, 1)), gem_string("\", ")), gem_to_string_fn(NULL, _t1472, 1)), gem_string(", NULL, 0)")));
    gem_table_set(_t1470, gem_string("setup"), gem_v_arg_setups);
                GemVal _t1473 = _t1470;
                gem_pop_frame();
                return _t1473;
            }
#line 650 "compiler/main.gem"
    GemVal _t1474 = (*gem_v_tmp);
            GemVal gem_v_t = _t1474.fn(_t1474.env, NULL, 0);
#line 651 "compiler/main.gem"
...
#line 655 "compiler/main.gem"
    ...
    GemVal _t1476[] = {gem_v_arr};
            GemVal gem_v_setup = gem_add(gem_v_arg_setups, gem_add(gem_add(gem_add(gem_add(gem_string("    GemVal "), gem_to_string_fn(NULL, _t1475, 1)), gem_string("[] = {")), gem_to_string_fn(NULL, _t1476, 1)), gem_string("};\n")));
#line 656 "compiler/main.gem"
    GemVal _t1477[] = {gem_v_escaped_file};
    GemVal _t1478[] = {gem_v_line};
    GemVal _t1479[] = {gem_v_t};
    GemVal _t1480[] = {gem_v_argc};
            GemVal gem_v_call = gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_string("gem_error_at_fn(\""), gem_to_string_fn(NULL, _t1477, 1)), gem_string("\", ")), gem_to_string_fn(NULL, _t1478, 1)), gem_string(", ")), gem_to_string_fn(NULL, _t1479, 1)), gem_string(", ")), gem_to_string_fn(NULL, _t1480, 1)), gem_string(")"));
#line 657 "compiler/main.gem"
    GemVal _t1481 = gem_table_new();
    gem_table_set(_t1481, gem_string("expr"), gem_v_call);
    gem_table_set(_t1481, gem_string("setup"), gem_v_setup);
            GemVal _t1482 = _t1481;
            gem_pop_frame();
            return _t1482;
        } else {
#line 658 "compiler/main.gem"
    GemVal _t1483;
    if (gem_truthy(gem_eq(gem_v_name, gem_string("print")))) {
        _t1483 = gem_eq(gem_v_name, gem_string("print"));
    } else {
        _t1483 = gem_eq(gem_v_name, gem_string("len"));
    }
    GemVal _t1484;
    if (gem_truthy(_t1483)) {
        _t1484 = _t1483;
    } else {
        _t1484 = gem_eq(gem_v_name, gem_string("type"));
    }
    GemVal _t1485;
    if (gem_truthy(_t1484)) {
        _t1485 = _t1484;
    } else {
        _t1485 = gem_eq(gem_v_name, gem_string("to_string"));
    }
    GemVal _t1486;
    if (gem_truthy(_t1485)) {
        _t1486 = _t1485;
    } else {
        _t1486 = gem_eq(gem_v_name, gem_string("push"));
    }
    GemVal _t1487;
    if (gem_truthy(_t1486)) {
        _t1487 = _t1486;
    } else {
        _t1487 = gem_eq(gem_v_name, gem_string("pcall"));
    }
    GemVal _t1488;
    if (gem_truthy(_t1487)) {
        _t1488 = _t1487;
    } else {
        _t1488 = gem_eq(gem_v_name, gem_string("keys"));
    }
    GemVal _t1489;
    if (gem_truthy(_t1488)) {
        _t1489 = _t1488;
    } else {
        _t1489 = gem_eq(gem_v_name, gem_string("str_replace"));
    }
...
#line 680 "compiler/main.gem"
    GemVal _t1492 = (*gem_v_compile_expr);
    GemVal _t1493[] = {gem_table_get(gem_v_args, gem_v_i)};
                        GemVal gem_v_r = _t1492.fn(_t1492.env, _t1493, 1);
#line 681 "compiler/main.gem"
    GemVal _t1494 = gem_v_r;
                        gem_v_arg_setups = gem_add(gem_v_arg_setups, gem_table_get(_t1494, gem_string("setup")));
#line 682 "compiler/main.gem"
    GemVal _t1495 = gem_v_r;
    GemVal _t1496[] = {gem_v_arg_exprs, gem_table_get(_t1495, gem_string("expr"))};
                        (void)(gem_push_fn(NULL, _t1496, 2));
                    }
                }
#line 684 "compiler/main.gem"
    GemVal _t1497[] = {gem_v_args};
                GemVal gem_v_argc = gem_len_fn(NULL, _t1497, 1);
#line 685 "compiler/main.gem"
                if (gem_truthy(gem_eq(gem_v_argc, gem_int(0)))) {
#line 686 "compiler/main.gem"
    GemVal _t1498 = gem_table_new();
    GemVal _t1499[] = {gem_v_fn_name};
    gem_table_set(_t1498, gem_string("expr"), gem_add(gem_to_string_fn(NULL, _t1499, 1), gem_string("(NULL, NULL, 0)")));
    gem_table_set(_t1498, gem_string("setup"), gem_v_arg_setups);
                    GemVal _t1500 = _t1498;
                    gem_pop_frame();
                    return _t1500;
                }
...
#line 694 "compiler/main.gem"
    ...
    GemVal _t1505[] = {gem_v_fn_name};
    GemVal _t1506[] = {gem_v_t};
    GemVal _t1507[] = {gem_v_argc};
    gem_table_set(_t1504, gem_string("expr"), gem_add(gem_add(gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t1505, 1), gem_string("(NULL, ")), gem_to_string_fn(NULL, _t1506, 1)), gem_string(", ")), gem_to_string_fn(NULL, _t1507, 1)), gem_string(")")));
    gem_table_set(_t1504, gem_string("setup"), gem_v_setup);
                GemVal _t1508 = _t1504;
                gem_pop_frame();
                return _t1508;
            } else {
...
#line 698 "compiler/main.gem"
    GemVal _t1511[] = {gem_v_args};
                        GemVal gem_v__for_limit_28 = gem_len_fn(NULL, _t1511, 1);
#line 698 "compiler/main.gem"
                        while (1) {
...
#line 705 "compiler/main.gem"
    ...
    gem_table_set(_t1518, gem_string("expr"), gem_add(gem_add(gem_string("gem_fn_"), gem_to_string_fn(NULL, _t1519, 1)), gem_string("(NULL, NULL, 0)")));
...
#line 712 "compiler/main.gem"
    ...
    GemVal _t1523[] = {gem_v_arr};
                    GemVal gem_v_setup = gem_add(gem_v_arg_setups, gem_add(gem_add(gem_add(gem_add(gem_string("    GemVal "), gem_to_string_fn(NULL, _t1522, 1)), gem_string("[] = {")), gem_to_string_fn(NULL, _t1523, 1)), gem_string("};\n")));
#line 713 "compiler/main.gem"
    GemVal _t1524 = gem_table_new();
    GemVal _t1525[] = {gem_v_name};
    GemVal _t1526[] = {gem_v_t};
    GemVal _t1527[] = {gem_v_argc};
    gem_table_set(_t1524, gem_string("expr"), gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_string("gem_fn_"), gem_to_string_fn(NULL, _t1525, 1)), gem_string("(NULL, ")), gem_to_string_fn(NULL, _t1526, 1)), gem_string(", ")), gem_to_string_fn(NULL, _t1527, 1)), gem_string(")")));
    gem_table_set(_t1524, gem_string("setup"), gem_v_setup);
                    GemVal _t1528 = _t1524;
                    gem_pop_frame();
                    return _t1528;
                }
            }
...
#line 718 "compiler/main.gem"
    GemVal _t1529 = (*gem_v_compile_expr);
    GemVal _t1530[] = {gem_v_func};
    GemVal gem_v_func_r = _t1529.fn(_t1529.env, _t1530, 1);
...
#line 721 "compiler/main.gem"
    GemVal _t1532[] = {gem_v_args};
        GemVal gem_v__for_limit_30 = gem_len_fn(NULL, _t1532, 1);
#line 721 "compiler/main.gem"
        while (1) {
...
#line 726 "compiler/main.gem"
    GemVal _t1538 = gem_v_func_r;
    GemVal gem_v_setup = gem_add(gem_table_get(_t1538, gem_string("setup")), gem_v_arg_setups);
#line 727 "compiler/main.gem"
    GemVal _t1539[] = {gem_v_args};
    GemVal gem_v_argc = gem_len_fn(NULL, _t1539, 1);
#line 728 "compiler/main.gem"
    GemVal _t1540 = (*gem_v_tmp);
    GemVal gem_v_tmp_fn = _t1540.fn(_t1540.env, NULL, 0);
#line 729 "compiler/main.gem"
    GemVal _t1541[] = {gem_v_tmp_fn};
    GemVal _t1542 = gem_v_func_r;
    GemVal _t1543[] = {gem_table_get(_t1542, gem_string("expr"))};
    gem_v_setup = gem_add(gem_v_setup, gem_add(gem_add(gem_add(gem_add(gem_string("    GemVal "), gem_to_string_fn(NULL, _t1541, 1)), gem_string(" = ")), gem_to_string_fn(NULL, _t1543, 1)), gem_string(";\n")));
#line 730 "compiler/main.gem"
    if (gem_truthy(gem_eq(gem_v_argc, gem_int(0)))) {
#line 731 "compiler/main.gem"
    GemVal _t1544 = gem_table_new();
    GemVal _t1545[] = {gem_v_tmp_fn};
    GemVal _t1546[] = {gem_v_tmp_fn};
    gem_table_set(_t1544, gem_string("expr"), gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t1545, 1), gem_string(".fn(")), gem_to_string_fn(NULL, _t1546, 1)), gem_string(".env, NULL, 0)")));
    gem_table_set(_t1544, gem_string("setup"), gem_v_setup);
        GemVal _t1547 = _t1544;
        gem_pop_frame();
        return _t1547;
    }
#line 733 "compiler/main.gem"
    GemVal _t1548 = (*gem_v_tmp);
    GemVal gem_v_tmp_args = _t1548.fn(_t1548.env, NULL, 0);
...
#line 738 "compiler/main.gem"
    GemVal _t1549[] = {gem_v_tmp_args};
    GemVal _t1550[] = {gem_v_arr};
    gem_v_setup = gem_add(gem_v_setup, gem_add(gem_add(gem_add(gem_add(gem_string("    GemVal "), gem_to_string_fn(NULL, _t1549, 1)), gem_string("[] = {")), gem_to_string_fn(NULL, _t1550, 1)), gem_string("};\n")));
#line 739 "compiler/main.gem"
    GemVal _t1551[] = {gem_v_tmp_fn};
    GemVal _t1552[] = {gem_v_tmp_fn};
    GemVal _t1553[] = {gem_v_tmp_args};
    GemVal _t1554[] = {gem_v_argc};
    GemVal gem_v_call = gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t1551, 1), gem_string(".fn(")), gem_to_string_fn(NULL, _t1552, 1)), gem_string(".env, ")), gem_to_string_fn(NULL, _t1553, 1)), gem_string(", ")), gem_to_string_fn(NULL, _t1554, 1)), gem_string(")"));
    GemVal _t1555 = gem_table_new();
    gem_table_set(_t1555, gem_string("expr"), gem_v_call);
...
#line 746 "compiler/main.gem"
    ...
    GemVal gem_v_op = gem_table_get(_t1558, gem_string("op"));
#line 747 "compiler/main.gem"
    GemVal _t1559 = gem_v_node;
    GemVal _t1560 = (*gem_v_compile_expr);
    GemVal _t1561[] = {gem_table_get(_t1559, gem_string("left"))};
    GemVal gem_v_lc_r = _t1560.fn(_t1560.env, _t1561, 1);
#line 748 "compiler/main.gem"
    GemVal _t1562 = gem_v_lc_r;
    GemVal gem_v_lc = gem_table_get(_t1562, gem_string("expr"));
#line 749 "compiler/main.gem"
    GemVal _t1563 = gem_v_lc_r;
    GemVal gem_v_ls = gem_table_get(_t1563, gem_string("setup"));
...
#line 753 "compiler/main.gem"
    ...
    gem_table_set(_t1567, gem_string("expr"), gem_add(gem_add(gem_add(gem_add(gem_string("gem_add("), gem_to_string_fn(NULL, _t1568, 1)), gem_string(", ")), gem_to_string_fn(NULL, _t1570, 1)), gem_string(")")));
...
#line 756 "compiler/main.gem"
    ...
    gem_table_set(_t1576, gem_string("expr"), gem_add(gem_add(gem_add(gem_add(gem_string("gem_sub("), gem_to_string_fn(NULL, _t1577, 1)), gem_string(", ")), gem_to_string_fn(NULL, _t1579, 1)), gem_string(")")));
...
#line 759 "compiler/main.gem"
    ...
    gem_table_set(_t1585, gem_string("expr"), gem_add(gem_add(gem_add(gem_add(gem_string("gem_mul("), gem_to_string_fn(NULL, _t1586, 1)), gem_string(", ")), gem_to_string_fn(NULL, _t1588, 1)), gem_string(")")));
...
#line 762 "compiler/main.gem"
    ...
    gem_table_set(_t1594, gem_string("expr"), gem_add(gem_add(gem_add(gem_add(gem_string("gem_div("), gem_to_string_fn(NULL, _t1595, 1)), gem_string(", ")), gem_to_string_fn(NULL, _t1597, 1)), gem_string(")")));
...
#line 765 "compiler/main.gem"
    ...
    gem_table_set(_t1603, gem_string("expr"), gem_add(gem_add(gem_add(gem_add(gem_string("gem_mod("), gem_to_string_fn(NULL, _t1604, 1)), gem_string(", ")), gem_to_string_fn(NULL, _t1606, 1)), gem_string(")")));
...
#line 768 "compiler/main.gem"
    ...
    gem_table_set(_t1612, gem_string("expr"), gem_add(gem_add(gem_add(gem_add(gem_string("gem_eq("), gem_to_string_fn(NULL, _t1613, 1)), gem_string(", ")), gem_to_string_fn(NULL, _t1615, 1)), gem_string(")")));
...
#line 771 "compiler/main.gem"
    ...
    gem_table_set(_t1621, gem_string("expr"), gem_add(gem_add(gem_add(gem_add(gem_string("gem_neq("), gem_to_string_fn(NULL, _t1622, 1)), gem_string(", ")), gem_to_string_fn(NULL, _t1624, 1)), gem_string(")")));
...
#line 774 "compiler/main.gem"
    ...
    gem_table_set(_t1630, gem_string("expr"), gem_add(gem_add(gem_add(gem_add(gem_string("gem_lt("), gem_to_string_fn(NULL, _t1631, 1)), gem_string(", ")), gem_to_string_fn(NULL, _t1633, 1)), gem_string(")")));
...
#line 777 "compiler/main.gem"
    ...
    gem_table_set(_t1639, gem_string("expr"), gem_add(gem_add(gem_add(gem_add(gem_string("gem_gt("), gem_to_string_fn(NULL, _t1640, 1)), gem_string(", ")), gem_to_string_fn(NULL, _t1642, 1)), gem_string(")")));
...
#line 780 "compiler/main.gem"
    ...
    gem_table_set(_t1648, gem_string("expr"), gem_add(gem_add(gem_add(gem_add(gem_string("gem_le("), gem_to_string_fn(NULL, _t1649, 1)), gem_string(", ")), gem_to_string_fn(NULL, _t1651, 1)), gem_string(")")));
...
#line 783 "compiler/main.gem"
    ...
    GemVal _t1660[] = {gem_table_get(_t1659, gem_string("expr"))};
    gem_table_set(_t1657, gem_string("expr"), gem_add(gem_add(gem_add(gem_add(gem_string("gem_ge("), gem_to_string_fn(NULL, _t1658, 1)), gem_string(", ")), gem_to_string_fn(NULL, _t1660, 1)), gem_string(")")));
    GemVal _t1661 = gem_v_rc_r;
    gem_table_set(_t1657, gem_string("setup"), gem_add(gem_v_ls, gem_table_get(_t1661, gem_string("setup"))));
                                                GemVal _t1662 = _t1657;
                                                gem_pop_frame();
                                                return _t1662;
                                            } else {
...
#line 785 "compiler/main.gem"
    GemVal _t1663 = gem_v_node;
    GemVal _t1664 = (*gem_v_compile_expr);
    GemVal _t1665[] = {gem_table_get(_t1663, gem_string("right"))};
                                                    GemVal gem_v_rc_r = _t1664.fn(_t1664.env, _t1665, 1);
#line 786 "compiler/main.gem"
    GemVal _t1666 = (*gem_v_tmp);
                                                    GemVal gem_v_t = _t1666.fn(_t1666.env, NULL, 0);
#line 787 "compiler/main.gem"
                                                    GemVal gem_v_setup = gem_v_ls;
#line 788 "compiler/main.gem"
    GemVal _t1667[] = {gem_v_t};
                                                    gem_v_setup = gem_add(gem_v_setup, gem_add(gem_add(gem_string("    GemVal "), gem_to_string_fn(NULL, _t1667, 1)), gem_string(";\n")));
#line 789 "compiler/main.gem"
    GemVal _t1668[] = {gem_v_lc};
                                                    gem_v_setup = gem_add(gem_v_setup, gem_add(gem_add(gem_string("    if (!gem_truthy("), gem_to_string_fn(NULL, _t1668, 1)), gem_string(")) {\n")));
#line 790 "compiler/main.gem"
    GemVal _t1669[] = {gem_v_t};
    GemVal _t1670[] = {gem_v_lc};
                                                    gem_v_setup = gem_add(gem_v_setup, gem_add(gem_add(gem_add(gem_add(gem_string("        "), gem_to_string_fn(NULL, _t1669, 1)), gem_string(" = ")), gem_to_string_fn(NULL, _t1670, 1)), gem_string(";\n")));
...
#line 792 "compiler/main.gem"
    GemVal _t1671 = gem_v_rc_r;
                                                    if (gem_truthy(gem_neq(gem_table_get(_t1671, gem_string("setup")), gem_string("")))) {
#line 793 "compiler/main.gem"
    GemVal _t1672 = gem_v_rc_r;
    GemVal _t1673[] = {gem_table_get(_t1672, gem_string("setup")), gem_string("    "), gem_string("        ")};
                                                        gem_v_setup = gem_add(gem_v_setup, gem_str_replace_fn(NULL, _t1673, 3));
                                                    }
#line 795 "compiler/main.gem"
    ...
    GemVal _t1676[] = {gem_table_get(_t1675, gem_string("expr"))};
                                                    gem_v_setup = gem_add(gem_v_setup, gem_add(gem_add(gem_add(gem_add(gem_string("        "), gem_to_string_fn(NULL, _t1674, 1)), gem_string(" = ")), gem_to_string_fn(NULL, _t1676, 1)), gem_string(";\n")));
...
#line 797 "compiler/main.gem"
    ...
    gem_table_set(_t1677, gem_string("expr"), gem_v_t);
    gem_table_set(_t1677, gem_string("setup"), gem_v_setup);
                                                    GemVal _t1678 = _t1677;
                                                    gem_pop_frame();
                                                    return _t1678;
                                                } else {
...
#line 800 "compiler/main.gem"
    GemVal _t1682 = (*gem_v_tmp);
                                                        GemVal gem_v_t = _t1682.fn(_t1682.env, NULL, 0);
#line 801 "compiler/main.gem"
                                                        GemVal gem_v_setup = gem_v_ls;
#line 802 "compiler/main.gem"
    GemVal _t1683[] = {gem_v_t};
                                                        gem_v_setup = gem_add(gem_v_setup, gem_add(gem_add(gem_string("    GemVal "), gem_to_string_fn(NULL, _t1683, 1)), gem_string(";\n")));
#line 803 "compiler/main.gem"
    GemVal _t1684[] = {gem_v_lc};
                                                        gem_v_setup = gem_add(gem_v_setup, gem_add(gem_add(gem_string("    if (gem_truthy("), gem_to_string_fn(NULL, _t1684, 1)), gem_string(")) {\n")));
#line 804 "compiler/main.gem"
    GemVal _t1685[] = {gem_v_t};
    GemVal _t1686[] = {gem_v_lc};
                                                        gem_v_setup = gem_add(gem_v_setup, gem_add(gem_add(gem_add(gem_add(gem_string("        "), gem_to_string_fn(NULL, _t1685, 1)), gem_string(" = ")), gem_to_string_fn(NULL, _t1686, 1)), gem_string(";\n")));
#line 805 "compiler/main.gem"
                                                        gem_v_setup = gem_add(gem_v_setup, gem_string("    } else {\n"));
#line 806 "compiler/main.gem"
    GemVal _t1687 = gem_v_rc_r;
                                                        if (gem_truthy(gem_neq(gem_table_get(_t1687, gem_string("setup")), gem_string("")))) {
#line 807 "compiler/main.gem"
    GemVal _t1688 = gem_v_rc_r;
    GemVal _t1689[] = {gem_table_get(_t1688, gem_string("setup")), gem_string("    "), gem_string("        ")};
                                                            gem_v_setup = gem_add(gem_v_setup, gem_str_replace_fn(NULL, _t1689, 3));
                                                        }
#line 809 "compiler/main.gem"
    GemVal _t1690[] = {gem_v_t};
    GemVal _t1691 = gem_v_rc_r;
    GemVal _t1692[] = {gem_table_get(_t1691, gem_string("expr"))};
                                                        gem_v_setup = gem_add(gem_v_setup, gem_add(gem_add(gem_add(gem_add(gem_string("        "), gem_to_string_fn(NULL, _t1690, 1)), gem_string(" = ")), gem_to_string_fn(NULL, _t1692, 1)), gem_string(";\n")));
#line 810 "compiler/main.gem"
                                                        gem_v_setup = gem_add(gem_v_setup, gem_string("    }\n"));
#line 811 "compiler/main.gem"
    GemVal _t1693 = gem_table_new();
    gem_table_set(_t1693, gem_string("expr"), gem_v_t);
    gem_table_set(_t1693, gem_string("setup"), gem_v_setup);
                                                        GemVal _t1694 = _t1693;
                                                        gem_pop_frame();
                                                        return _t1694;
                                                    }
                                                }
...
#line 814 "compiler/main.gem"
    ...
    GemVal _t1696 = (*gem_v_compile_expr);
    GemVal _t1697[] = {gem_table_get(_t1695, gem_string("right"))};
    GemVal gem_v_rc_r = _t1696.fn(_t1696.env, _t1697, 1);
    GemVal _t1698 = gem_table_new();
    gem_table_set(_t1698, gem_string("expr"), gem_string("GEM_NIL"));
    GemVal _t1699 = gem_v_rc_r;
    gem_table_set(_t1698, gem_string("setup"), gem_add(gem_add(gem_add(gem_add(gem_v_ls, gem_table_get(_t1699, gem_string("setup"))), gem_string("/* unknown op: ")), gem_v_op), gem_string(" */\n")));
    GemVal _t1700 = _t1698;
    gem_pop_frame();
    return _t1700;
}
...
#line 822 "compiler/main.gem"
        while (1) {
            GemVal _t1702[] = {gem_v__for_items_32};
            if (!gem_truthy(gem_lt(gem_v__for_i_32, gem_len_fn(NULL, _t1702, 1)))) break;
#line 822 "compiler/main.gem"
...
#line 823 "compiler/main.gem"
    GemVal _t1703 = (*gem_v_compile_stmt);
    GemVal _t1704[] = {gem_v_stmt, gem_v_indent};
            gem_v_out = gem_add(gem_add(gem_v_out, _t1703.fn(_t1703.env, _t1704, 2)), gem_string("\n"));
        }
    }
    GemVal _t1705 = gem_v_out;
    gem_pop_frame();
    return _t1705;
}
...
#line 831 "compiler/main.gem"
    GemVal _t1707[] = {gem_v_indent};
    GemVal gem_v_p = gem_fn_pad_for(NULL, _t1707, 1);
#line 832 "compiler/main.gem"
    GemVal _t1708 = gem_v_node;
    GemVal gem_v_tag = gem_table_get(_t1708, gem_string("tag"));
#line 833 "compiler/main.gem"
    GemVal gem_v_line_dir = gem_string("");
#line 834 "compiler/main.gem"
    GemVal _t1709 = gem_v_node;
    if (gem_truthy(gem_neq(gem_table_get(_t1709, gem_string("line")), GEM_NIL))) {
#line 835 "compiler/main.gem"
    GemVal _t1710 = gem_v_node;
    GemVal _t1711[] = {gem_table_get(_t1710, gem_string("line"))};
    GemVal _t1712[] = {(*gem_v_source_name)};
    GemVal _t1713[] = {gem_fn_escape_c_string(NULL, _t1712, 1)};
        gem_v_line_dir = gem_add(gem_add(gem_add(gem_add(gem_string("#line "), gem_to_string_fn(NULL, _t1711, 1)), gem_string(" \"")), gem_to_string_fn(NULL, _t1713, 1)), gem_string("\"\n"));
    }
...
#line 839 "compiler/main.gem"
    ...
    GemVal _t1716[] = {gem_table_get(_t1714, gem_string("value"))};
        GemVal gem_v_r = _t1715.fn(_t1715.env, _t1716, 1);
#line 840 "compiler/main.gem"
    GemVal _t1717 = gem_v_node;
        GemVal gem_v_name = gem_table_get(_t1717, gem_string("name"));
#line 841 "compiler/main.gem"
    GemVal _t1718 = (*gem_v_mangle);
    GemVal _t1719[] = {gem_v_name};
        GemVal gem_v_mname = _t1718.fn(_t1718.env, _t1719, 1);
#line 842 "compiler/main.gem"
    GemVal _t1720[] = {(*gem_v_boxed_vars), gem_v_name};
        if (gem_truthy(gem_fn_set_contains(NULL, _t1720, 2))) {
#line 843 "compiler/main.gem"
    GemVal _t1721[] = {gem_v_line_dir};
    GemVal _t1722 = gem_v_r;
    GemVal _t1723[] = {gem_table_get(_t1722, gem_string("setup"))};
    GemVal _t1724[] = {gem_v_p};
    GemVal _t1725[] = {gem_v_mname};
    GemVal _t1726[] = {gem_v_p};
    GemVal _t1727[] = {gem_v_mname};
    GemVal _t1728 = gem_v_r;
    GemVal _t1729[] = {gem_table_get(_t1728, gem_string("expr"))};
            GemVal _t1730 = gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t1721, 1), gem_to_string_fn(NULL, _t1723, 1)), gem_to_string_fn(NULL, _t1724, 1)), gem_string("GemVal *")), gem_to_string_fn(NULL, _t1725, 1)), gem_string(" = GC_MALLOC(sizeof(GemVal));\n")), gem_to_string_fn(NULL, _t1726, 1)), gem_string("*")), gem_to_string_fn(NULL, _t1727, 1)), gem_string(" = ")), gem_to_string_fn(NULL, _t1729, 1)), gem_string(";"));
            gem_pop_frame();
            return _t1730;
        }
#line 845 "compiler/main.gem"
    GemVal _t1731[] = {gem_v_line_dir};
    GemVal _t1732 = gem_v_r;
    GemVal _t1733[] = {gem_table_get(_t1732, gem_string("setup"))};
    GemVal _t1734[] = {gem_v_p};
    GemVal _t1735[] = {gem_v_mname};
    GemVal _t1736 = gem_v_r;
    GemVal _t1737[] = {gem_table_get(_t1736, gem_string("expr"))};
        GemVal _t1738 = gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t1731, 1), gem_to_string_fn(NULL, _t1733, 1)), gem_to_string_fn(NULL, _t1734, 1)), gem_string("GemVal ")), gem_to_string_fn(NULL, _t1735, 1)), gem_string(" = ")), gem_to_string_fn(NULL, _t1737, 1)), gem_string(";"));
        gem_pop_frame();
        return _t1738;
    } else {
...
#line 847 "compiler/main.gem"
    ...
    GemVal _t1741[] = {gem_table_get(_t1739, gem_string("value"))};
            GemVal gem_v_r = _t1740.fn(_t1740.env, _t1741, 1);
#line 848 "compiler/main.gem"
    GemVal _t1742 = gem_v_node;
            GemVal gem_v_name = gem_table_get(_t1742, gem_string("name"));
#line 849 "compiler/main.gem"
    GemVal _t1743 = (*gem_v_mangle);
    GemVal _t1744[] = {gem_v_name};
            GemVal gem_v_mname = _t1743.fn(_t1743.env, _t1744, 1);
#line 850 "compiler/main.gem"
    GemVal _t1745[] = {(*gem_v_boxed_vars), gem_v_name};
            if (gem_truthy(gem_fn_set_contains(NULL, _t1745, 2))) {
#line 851 "compiler/main.gem"
    GemVal _t1746[] = {gem_v_line_dir};
    GemVal _t1747 = gem_v_r;
    GemVal _t1748[] = {gem_table_get(_t1747, gem_string("setup"))};
    GemVal _t1749[] = {gem_v_p};
    GemVal _t1750[] = {gem_v_mname};
    GemVal _t1751 = gem_v_r;
    GemVal _t1752[] = {gem_table_get(_t1751, gem_string("expr"))};
                GemVal _t1753 = gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t1746, 1), gem_to_string_fn(NULL, _t1748, 1)), gem_to_string_fn(NULL, _t1749, 1)), gem_string("*")), gem_to_string_fn(NULL, _t1750, 1)), gem_string(" = ")), gem_to_string_fn(NULL, _t1752, 1)), gem_string(";"));
                gem_pop_frame();
                return _t1753;
            }
#line 853 "compiler/main.gem"
    ...
    GemVal _t1760[] = {gem_table_get(_t1759, gem_string("expr"))};
            GemVal _t1761 = gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t1754, 1), gem_to_string_fn(NULL, _t1756, 1)), gem_to_string_fn(NULL, _t1757, 1)), gem_to_string_fn(NULL, _t1758, 1)), gem_string(" = ")), gem_to_string_fn(NULL, _t1760, 1)), gem_string(";"));
            gem_pop_frame();
            return _t1761;
        } else {
...
#line 855 "compiler/main.gem"
    ...
    GemVal _t1764[] = {gem_table_get(_t1762, gem_string("object"))};
                GemVal gem_v_obj_r = _t1763.fn(_t1763.env, _t1764, 1);
#line 856 "compiler/main.gem"
    GemVal _t1765 = gem_v_node;
    GemVal _t1766 = (*gem_v_compile_expr);
    GemVal _t1767[] = {gem_table_get(_t1765, gem_string("value"))};
                GemVal gem_v_val_r = _t1766.fn(_t1766.env, _t1767, 1);
#line 857 "compiler/main.gem"
    GemVal _t1768 = gem_v_node;
    GemVal _t1769[] = {gem_table_get(_t1768, gem_string("field"))};
                GemVal gem_v_escaped = gem_fn_escape_c_string(NULL, _t1769, 1);
#line 858 "compiler/main.gem"
    GemVal _t1770[] = {gem_v_line_dir};
    GemVal _t1771 = gem_v_obj_r;
    GemVal _t1772[] = {gem_table_get(_t1771, gem_string("setup"))};
    GemVal _t1773 = gem_v_val_r;
    GemVal _t1774[] = {gem_table_get(_t1773, gem_string("setup"))};
    GemVal _t1775[] = {gem_v_p};
    GemVal _t1776 = gem_v_obj_r;
    GemVal _t1777[] = {gem_table_get(_t1776, gem_string("expr"))};
    GemVal _t1778[] = {gem_v_escaped};
    GemVal _t1779 = gem_v_val_r;
    GemVal _t1780[] = {gem_table_get(_t1779, gem_string("expr"))};
                GemVal _t1781 = gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t1770, 1), gem_to_string_fn(NULL, _t1772, 1)), gem_to_string_fn(NULL, _t1774, 1)), gem_to_string_fn(NULL, _t1775, 1)), gem_string("gem_table_set(")), gem_to_string_fn(NULL, _t1777, 1)), gem_string(", gem_string(\"")), gem_to_string_fn(NULL, _t1778, 1)), gem_string("\"), ")), gem_to_string_fn(NULL, _t1780, 1)), gem_string(");"));
                gem_pop_frame();
                return _t1781;
            } else {
...
#line 860 "compiler/main.gem"
    ...
    GemVal _t1784[] = {gem_table_get(_t1782, gem_string("object"))};
                    GemVal gem_v_obj_r = _t1783.fn(_t1783.env, _t1784, 1);
#line 861 "compiler/main.gem"
    GemVal _t1785 = gem_v_node;
    GemVal _t1786 = (*gem_v_compile_expr);
    GemVal _t1787[] = {gem_table_get(_t1785, gem_string("key"))};
                    GemVal gem_v_key_r = _t1786.fn(_t1786.env, _t1787, 1);
...
#line 863 "compiler/main.gem"
    ...
    GemVal _t1802[] = {gem_table_get(_t1801, gem_string("expr"))};
    GemVal _t1803 = gem_v_val_r;
    GemVal _t1804[] = {gem_table_get(_t1803, gem_string("expr"))};
                    GemVal _t1805 = gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t1791, 1), gem_to_string_fn(NULL, _t1793, 1)), gem_to_string_fn(NULL, _t1795, 1)), gem_to_string_fn(NULL, _t1797, 1)), gem_to_string_fn(NULL, _t1798, 1)), gem_string("gem_table_set(")), gem_to_string_fn(NULL, _t1800, 1)), gem_string(", ")), gem_to_string_fn(NULL, _t1802, 1)), gem_string(", ")), gem_to_string_fn(NULL, _t1804, 1)), gem_string(");"));
                    gem_pop_frame();
                    return _t1805;
                } else {
...
#line 865 "compiler/main.gem"
    GemVal _t1806[] = {gem_v_line_dir};
    GemVal _t1807 = (*gem_v_compile_if);
    GemVal _t1808[] = {gem_v_node, gem_v_indent};
                        GemVal _t1809 = gem_add(gem_to_string_fn(NULL, _t1806, 1), _t1807.fn(_t1807.env, _t1808, 2));
                        gem_pop_frame();
                        return _t1809;
                    } else {
...
#line 867 "compiler/main.gem"
    ...
    GemVal _t1811 = (*gem_v_compile_while);
    GemVal _t1812[] = {gem_v_node, gem_v_indent};
                            GemVal _t1813 = gem_add(gem_to_string_fn(NULL, _t1810, 1), _t1811.fn(_t1811.env, _t1812, 2));
                            gem_pop_frame();
                            return _t1813;
                        } else {
...
#line 869 "compiler/main.gem"
    ...
    GemVal _t1815 = (*gem_v_compile_match);
    GemVal _t1816[] = {gem_v_node, gem_v_indent};
                                GemVal _t1817 = gem_add(gem_to_string_fn(NULL, _t1814, 1), _t1815.fn(_t1815.env, _t1816, 2));
                                gem_pop_frame();
                                return _t1817;
                            } else {
...
#line 871 "compiler/main.gem"
                                    GemVal _t1818 = gem_add(gem_v_p, gem_string("break;"));
                                    gem_pop_frame();
                                    return _t1818;
                                } else {
...
#line 873 "compiler/main.gem"
                                        GemVal _t1819 = gem_add(gem_v_p, gem_string("continue;"));
                                        gem_pop_frame();
                                        return _t1819;
                                    } else {
...
#line 875 "compiler/main.gem"
    GemVal _t1820 = gem_v_node;
                                            if (gem_truthy(gem_neq(gem_table_get(_t1820, gem_string("value")), GEM_NIL))) {
#line 876 "compiler/main.gem"
    ...
    GemVal _t1823[] = {gem_table_get(_t1821, gem_string("value"))};
                                                GemVal gem_v_r = _t1822.fn(_t1822.env, _t1823, 1);
...
#line 878 "compiler/main.gem"
    ...
    GemVal _t1826 = gem_v_r;
    GemVal _t1827[] = {gem_table_get(_t1826, gem_string("setup"))};
    GemVal _t1828[] = {gem_v_p};
    GemVal _t1829[] = {gem_v_t};
    GemVal _t1830 = gem_v_r;
    GemVal _t1831[] = {gem_table_get(_t1830, gem_string("expr"))};
    GemVal _t1832[] = {gem_v_p};
    GemVal _t1833[] = {gem_v_p};
    GemVal _t1834[] = {gem_v_t};
                                                GemVal _t1835 = gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t1825, 1), gem_to_string_fn(NULL, _t1827, 1)), gem_to_string_fn(NULL, _t1828, 1)), gem_string("GemVal ")), gem_to_string_fn(NULL, _t1829, 1)), gem_string(" = ")), gem_to_string_fn(NULL, _t1831, 1)), gem_string(";\n")), gem_to_string_fn(NULL, _t1832, 1)), gem_string("gem_pop_frame();\n")), gem_to_string_fn(NULL, _t1833, 1)), gem_string("return ")), gem_to_string_fn(NULL, _t1834, 1)), gem_string(";"));
                                                gem_pop_frame();
                                                return _t1835;
                                            }
#line 880 "compiler/main.gem"
    ...
    GemVal _t1838[] = {gem_v_p};
                                            GemVal _t1839 = gem_add(gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t1836, 1), gem_to_string_fn(NULL, _t1837, 1)), gem_string("gem_pop_frame();\n")), gem_to_string_fn(NULL, _t1838, 1)), gem_string("return GEM_NIL;"));
                                            gem_pop_frame();
                                            return _t1839;
                                        } else {
...
#line 882 "compiler/main.gem"
    GemVal _t1840 = (*gem_v_compile_expr);
    GemVal _t1841[] = {gem_v_node};
                                                GemVal gem_v_r = _t1840.fn(_t1840.env, _t1841, 1);
#line 883 "compiler/main.gem"
    GemVal _t1842[] = {gem_v_line_dir};
    ...
    GemVal _t1847[] = {gem_table_get(_t1846, gem_string("expr"))};
                                                GemVal _t1848 = gem_add(gem_add(gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t1842, 1), gem_to_string_fn(NULL, _t1844, 1)), gem_to_string_fn(NULL, _t1845, 1)), gem_string("(void)(")), gem_to_string_fn(NULL, _t1847, 1)), gem_string(");"));
                                                gem_pop_frame();
                                                return _t1848;
                                            } else {
...
#line 887 "compiler/main.gem"
    GemVal _t1850[] = {gem_v_p};
                                                        GemVal gem_v_out = gem_add(gem_to_string_fn(NULL, _t1850, 1), gem_string("{\n"));
                                                        {
#line 888 "compiler/main.gem"
    GemVal _t1851 = gem_v_node;
                                                            GemVal gem_v__for_items_33 = gem_table_get(_t1851, gem_string("stmts"));
#line 888 "compiler/main.gem"
                                                            GemVal gem_v__for_i_33 = gem_int(0);
#line 888 "compiler/main.gem"
                                                            while (1) {
                                                                GemVal _t1852[] = {gem_v__for_items_33};
                                                                if (!gem_truthy(gem_lt(gem_v__for_i_33, gem_len_fn(NULL, _t1852, 1)))) break;
#line 888 "compiler/main.gem"
...
#line 889 "compiler/main.gem"
    GemVal _t1853 = (*gem_v_compile_stmt);
    GemVal _t1854[] = {gem_v_stmt, gem_add(gem_v_indent, gem_int(1))};
                                                                gem_v_out = gem_add(gem_add(gem_v_out, _t1853.fn(_t1853.env, _t1854, 2)), gem_string("\n"));
                                                            }
                                                        }
#line 891 "compiler/main.gem"
    GemVal _t1855[] = {gem_v_p};
                                                        gem_v_out = gem_add(gem_v_out, gem_add(gem_to_string_fn(NULL, _t1855, 1), gem_string("}")));
#line 892 "compiler/main.gem"
                                                        GemVal _t1856 = gem_v_out;
                                                        gem_pop_frame();
                                                        return _t1856;
                                                    }
                                                }
...
#line 895 "compiler/main.gem"
    ...
    GemVal gem_v_r = _t1857.fn(_t1857.env, _t1858, 1);
    ...
    GemVal _t1865 = gem_add(gem_add(gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t1859, 1), gem_to_string_fn(NULL, _t1861, 1)), gem_to_string_fn(NULL, _t1862, 1)), gem_string("(void)(")), gem_to_string_fn(NULL, _t1864, 1)), gem_string(");"));
    gem_pop_frame();
    return _t1865;
}
...
#line 902 "compiler/main.gem"
    GemVal _t1867[] = {gem_v_indent};
    GemVal gem_v_p = gem_fn_pad_for(NULL, _t1867, 1);
#line 903 "compiler/main.gem"
    GemVal _t1868 = gem_v_node;
    GemVal gem_v_tag = gem_table_get(_t1868, gem_string("tag"));
#line 904 "compiler/main.gem"
    GemVal gem_v_line_dir = gem_string("");
#line 905 "compiler/main.gem"
    GemVal _t1869 = gem_v_node;
    if (gem_truthy(gem_neq(gem_table_get(_t1869, gem_string("line")), GEM_NIL))) {
#line 906 "compiler/main.gem"
    GemVal _t1870 = gem_v_node;
    GemVal _t1871[] = {gem_table_get(_t1870, gem_string("line"))};
    GemVal _t1872[] = {(*gem_v_source_name)};
    GemVal _t1873[] = {gem_fn_escape_c_string(NULL, _t1872, 1)};
        gem_v_line_dir = gem_add(gem_add(gem_add(gem_add(gem_string("#line "), gem_to_string_fn(NULL, _t1871, 1)), gem_string(" \"")), gem_to_string_fn(NULL, _t1873, 1)), gem_string("\"\n"));
    }
...
#line 911 "compiler/main.gem"
    GemVal _t1877 = gem_v_node;
        GemVal gem_v_name = gem_table_get(_t1877, gem_string("name"));
#line 912 "compiler/main.gem"
    GemVal _t1878 = (*gem_v_mangle);
    GemVal _t1879[] = {gem_v_name};
        GemVal gem_v_mname = _t1878.fn(_t1878.env, _t1879, 1);
#line 913 "compiler/main.gem"
    GemVal _t1880[] = {(*gem_v_boxed_vars), gem_v_name};
        if (gem_truthy(gem_fn_set_contains(NULL, _t1880, 2))) {
#line 914 "compiler/main.gem"
    GemVal _t1881[] = {gem_v_line_dir};
    GemVal _t1882 = gem_v_r;
    GemVal _t1883[] = {gem_table_get(_t1882, gem_string("setup"))};
    GemVal _t1884[] = {gem_v_p};
    GemVal _t1885[] = {gem_v_mname};
    GemVal _t1886[] = {gem_v_p};
    GemVal _t1887[] = {gem_v_mname};
    GemVal _t1888 = gem_v_r;
    GemVal _t1889[] = {gem_table_get(_t1888, gem_string("expr"))};
    GemVal _t1890[] = {gem_v_p};
    GemVal _t1891[] = {gem_v_p};
            GemVal _t1892 = gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t1881, 1), gem_to_string_fn(NULL, _t1883, 1)), gem_to_string_fn(NULL, _t1884, 1)), gem_string("GemVal *")), gem_to_string_fn(NULL, _t1885, 1)), gem_string(" = GC_MALLOC(sizeof(GemVal));\n")), gem_to_string_fn(NULL, _t1886, 1)), gem_string("*")), gem_to_string_fn(NULL, _t1887, 1)), gem_string(" = ")), gem_to_string_fn(NULL, _t1889, 1)), gem_string(";\n")), gem_to_string_fn(NULL, _t1890, 1)), gem_string("gem_pop_frame();\n")), gem_to_string_fn(NULL, _t1891, 1)), gem_string("return GEM_NIL;"));
            gem_pop_frame();
            return _t1892;
        }
#line 916 "compiler/main.gem"
    GemVal _t1893[] = {gem_v_line_dir};
    GemVal _t1894 = gem_v_r;
    GemVal _t1895[] = {gem_table_get(_t1894, gem_string("setup"))};
    GemVal _t1896[] = {gem_v_p};
    GemVal _t1897[] = {gem_v_mname};
    GemVal _t1898 = gem_v_r;
    GemVal _t1899[] = {gem_table_get(_t1898, gem_string("expr"))};
    GemVal _t1900[] = {gem_v_p};
    GemVal _t1901[] = {gem_v_p};
        GemVal _t1902 = gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t1893, 1), gem_to_string_fn(NULL, _t1895, 1)), gem_to_string_fn(NULL, _t1896, 1)), gem_string("GemVal ")), gem_to_string_fn(NULL, _t1897, 1)), gem_string(" = ")), gem_to_string_fn(NULL, _t1899, 1)), gem_string(";\n")), gem_to_string_fn(NULL, _t1900, 1)), gem_string("gem_pop_frame();\n")), gem_to_string_fn(NULL, _t1901, 1)), gem_string("return GEM_NIL;"));
        gem_pop_frame();
        return _t1902;
    } else {
...
#line 918 "compiler/main.gem"
    ...
    GemVal _t1904 = (*gem_v_compile_expr);
    GemVal _t1905[] = {gem_table_get(_t1903, gem_string("value"))};
            GemVal gem_v_r = _t1904.fn(_t1904.env, _t1905, 1);
#line 919 "compiler/main.gem"
    GemVal _t1906 = (*gem_v_tmp);
            GemVal gem_v_t = _t1906.fn(_t1906.env, NULL, 0);
...
#line 923 "compiler/main.gem"
    ...
    GemVal _t1919[] = {gem_v_mname};
    GemVal _t1920[] = {gem_v_t};
    GemVal _t1921[] = {gem_v_p};
    GemVal _t1922[] = {gem_v_p};
    GemVal _t1923[] = {gem_v_t};
                GemVal _t1924 = gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t1911, 1), gem_to_string_fn(NULL, _t1913, 1)), gem_to_string_fn(NULL, _t1914, 1)), gem_string("GemVal ")), gem_to_string_fn(NULL, _t1915, 1)), gem_string(" = ")), gem_to_string_fn(NULL, _t1917, 1)), gem_string(";\n")), gem_to_string_fn(NULL, _t1918, 1)), gem_string("*")), gem_to_string_fn(NULL, _t1919, 1)), gem_string(" = ")), gem_to_string_fn(NULL, _t1920, 1)), gem_string(";\n")), gem_to_string_fn(NULL, _t1921, 1)), gem_string("gem_pop_frame();\n")), gem_to_string_fn(NULL, _t1922, 1)), gem_string("return ")), gem_to_string_fn(NULL, _t1923, 1)), gem_string(";"));
                gem_pop_frame();
                return _t1924;
            }
#line 925 "compiler/main.gem"
    ...
    GemVal _t1929[] = {gem_v_t};
    GemVal _t1930 = gem_v_r;
    GemVal _t1931[] = {gem_table_get(_t1930, gem_string("expr"))};
    GemVal _t1932[] = {gem_v_p};
    GemVal _t1933[] = {gem_v_mname};
    GemVal _t1934[] = {gem_v_t};
    GemVal _t1935[] = {gem_v_p};
    GemVal _t1936[] = {gem_v_p};
    GemVal _t1937[] = {gem_v_t};
            GemVal _t1938 = gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t1925, 1), gem_to_string_fn(NULL, _t1927, 1)), gem_to_string_fn(NULL, _t1928, 1)), gem_string("GemVal ")), gem_to_string_fn(NULL, _t1929, 1)), gem_string(" = ")), gem_to_string_fn(NULL, _t1931, 1)), gem_string(";\n")), gem_to_string_fn(NULL, _t1932, 1)), gem_to_string_fn(NULL, _t1933, 1)), gem_string(" = ")), gem_to_string_fn(NULL, _t1934, 1)), gem_string(";\n")), gem_to_string_fn(NULL, _t1935, 1)), gem_string("gem_pop_frame();\n")), gem_to_string_fn(NULL, _t1936, 1)), gem_string("return ")), gem_to_string_fn(NULL, _t1937, 1)), gem_string(";"));
            gem_pop_frame();
            return _t1938;
        } else {
...
#line 927 "compiler/main.gem"
    GemVal _t1939 = gem_v_node;
                if (gem_truthy(gem_neq(gem_table_get(_t1939, gem_string("value")), GEM_NIL))) {
...
#line 929 "compiler/main.gem"
    GemVal _t1943 = (*gem_v_tmp);
                    GemVal gem_v_t = _t1943.fn(_t1943.env, NULL, 0);
#line 930 "compiler/main.gem"
    ...
    GemVal _t1953[] = {gem_v_t};
                    GemVal _t1954 = gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t1944, 1), gem_to_string_fn(NULL, _t1946, 1)), gem_to_string_fn(NULL, _t1947, 1)), gem_string("GemVal ")), gem_to_string_fn(NULL, _t1948, 1)), gem_string(" = ")), gem_to_string_fn(NULL, _t1950, 1)), gem_string(";\n")), gem_to_string_fn(NULL, _t1951, 1)), gem_string("gem_pop_frame();\n")), gem_to_string_fn(NULL, _t1952, 1)), gem_string("return ")), gem_to_string_fn(NULL, _t1953, 1)), gem_string(";"));
                    gem_pop_frame();
                    return _t1954;
                }
#line 932 "compiler/main.gem"
    ...
    GemVal _t1957[] = {gem_v_p};
                GemVal _t1958 = gem_add(gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t1955, 1), gem_to_string_fn(NULL, _t1956, 1)), gem_string("gem_pop_frame();\n")), gem_to_string_fn(NULL, _t1957, 1)), gem_string("return GEM_NIL;"));
                gem_pop_frame();
                return _t1958;
            } else {
...
#line 934 "compiler/main.gem"
    ...
    GemVal _t1960 = (*gem_v_compile_if_return);
    GemVal _t1961[] = {gem_v_node, gem_v_indent};
                    GemVal _t1962 = gem_add(gem_to_string_fn(NULL, _t1959, 1), _t1960.fn(_t1960.env, _t1961, 2));
                    gem_pop_frame();
                    return _t1962;
                } else {
...
#line 936 "compiler/main.gem"
    ...
    GemVal _t1964 = (*gem_v_compile_while);
    GemVal _t1965[] = {gem_v_node, gem_v_indent};
    GemVal _t1966[] = {_t1964.fn(_t1964.env, _t1965, 2)};
    GemVal _t1967[] = {gem_v_p};
    GemVal _t1968[] = {gem_v_p};
                        GemVal _t1969 = gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t1963, 1), gem_to_string_fn(NULL, _t1966, 1)), gem_string("\n")), gem_to_string_fn(NULL, _t1967, 1)), gem_string("gem_pop_frame();\n")), gem_to_string_fn(NULL, _t1968, 1)), gem_string("return GEM_NIL;"));
                        gem_pop_frame();
                        return _t1969;
                    } else {
...
#line 938 "compiler/main.gem"
    ...
    GemVal _t1971 = (*gem_v_compile_match_return);
    GemVal _t1972[] = {gem_v_node, gem_v_indent};
                            GemVal _t1973 = gem_add(gem_to_string_fn(NULL, _t1970, 1), _t1971.fn(_t1971.env, _t1972, 2));
                            gem_pop_frame();
                            return _t1973;
                        } else {
...
#line 940 "compiler/main.gem"
    GemVal _t1974[] = {gem_v_p};
                                GemVal gem_v_out = gem_add(gem_to_string_fn(NULL, _t1974, 1), gem_string("{\n"));
                                {
#line 941 "compiler/main.gem"
                                    GemVal gem_v__for_i_34 = gem_int(0);
#line 941 "compiler/main.gem"
    GemVal _t1975 = gem_v_node;
    GemVal _t1976[] = {gem_table_get(_t1975, gem_string("stmts"))};
                                    GemVal gem_v__for_limit_34 = gem_sub(gem_len_fn(NULL, _t1976, 1), gem_int(1));
#line 941 "compiler/main.gem"
                                    while (1) {
...
#line 942 "compiler/main.gem"
    ...
    GemVal _t1978 = (*gem_v_compile_stmt);
    GemVal _t1979[] = {gem_table_get(gem_table_get(_t1977, gem_string("stmts")), gem_v_i), gem_add(gem_v_indent, gem_int(1))};
                                        gem_v_out = gem_add(gem_add(gem_v_out, _t1978.fn(_t1978.env, _t1979, 2)), gem_string("\n"));
                                    }
                                }
#line 944 "compiler/main.gem"
    GemVal _t1980 = gem_v_node;
    GemVal _t1981[] = {gem_table_get(_t1980, gem_string("stmts"))};
                                if (gem_truthy(gem_gt(gem_len_fn(NULL, _t1981, 1), gem_int(0)))) {
#line 945 "compiler/main.gem"
    ...
    GemVal _t1986[] = {gem_table_get(gem_table_get(_t1982, gem_string("stmts")), gem_sub(gem_len_fn(NULL, _t1984, 1), gem_int(1))), gem_add(gem_v_indent, gem_int(1))};
...
#line 947 "compiler/main.gem"
    GemVal _t1987[] = {gem_v_p};
                                gem_v_out = gem_add(gem_v_out, gem_add(gem_to_string_fn(NULL, _t1987, 1), gem_string("}")));
#line 948 "compiler/main.gem"
                                GemVal _t1988 = gem_v_out;
                                gem_pop_frame();
                                return _t1988;
                            } else {
#line 949 "compiler/main.gem"
    GemVal _t1989;
    if (gem_truthy(gem_eq(gem_v_tag, gem_string("dot_assign")))) {
        _t1989 = gem_eq(gem_v_tag, gem_string("dot_assign"));
    } else {
        _t1989 = gem_eq(gem_v_tag, gem_string("index_assign"));
    }
    GemVal _t1990;
    if (gem_truthy(_t1989)) {
        _t1990 = _t1989;
    } else {
        _t1990 = gem_eq(gem_v_tag, gem_string("break"));
    }
    GemVal _t1991;
    if (gem_truthy(_t1990)) {
        _t1991 = _t1990;
    } else {
        _t1991 = gem_eq(gem_v_tag, gem_string("continue"));
    }
    GemVal _t1992;
    if (gem_truthy(_t1991)) {
        _t1992 = _t1991;
    } else {
        _t1992 = gem_eq(gem_v_tag, gem_string("fn_def"));
    }
                                if (gem_truthy(_t1992)) {
#line 950 "compiler/main.gem"
    GemVal _t1993 = (*gem_v_compile_stmt);
    GemVal _t1994[] = {gem_v_node, gem_v_indent};
    GemVal _t1995[] = {_t1993.fn(_t1993.env, _t1994, 2)};
    GemVal _t1996[] = {gem_v_p};
    GemVal _t1997[] = {gem_v_p};
                                    GemVal _t1998 = gem_add(gem_add(gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t1995, 1), gem_string("\n")), gem_to_string_fn(NULL, _t1996, 1)), gem_string("gem_pop_frame();\n")), gem_to_string_fn(NULL, _t1997, 1)), gem_string("return GEM_NIL;"));
                                    gem_pop_frame();
                                    return _t1998;
                                }
                            }
...
#line 953 "compiler/main.gem"
    GemVal _t1999 = (*gem_v_compile_expr);
    GemVal _t2000[] = {gem_v_node};
    GemVal gem_v_r = _t1999.fn(_t1999.env, _t2000, 1);
#line 954 "compiler/main.gem"
    GemVal _t2001 = (*gem_v_tmp);
    GemVal gem_v_t = _t2001.fn(_t2001.env, NULL, 0);
    GemVal _t2002[] = {gem_v_line_dir};
    GemVal _t2003 = gem_v_r;
    GemVal _t2004[] = {gem_table_get(_t2003, gem_string("setup"))};
    GemVal _t2005[] = {gem_v_p};
    GemVal _t2006[] = {gem_v_t};
    GemVal _t2007 = gem_v_r;
    GemVal _t2008[] = {gem_table_get(_t2007, gem_string("expr"))};
    GemVal _t2009[] = {gem_v_p};
    GemVal _t2010[] = {gem_v_p};
    GemVal _t2011[] = {gem_v_t};
    GemVal _t2012 = gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t2002, 1), gem_to_string_fn(NULL, _t2004, 1)), gem_to_string_fn(NULL, _t2005, 1)), gem_string("GemVal ")), gem_to_string_fn(NULL, _t2006, 1)), gem_string(" = ")), gem_to_string_fn(NULL, _t2008, 1)), gem_string(";\n")), gem_to_string_fn(NULL, _t2009, 1)), gem_string("gem_pop_frame();\n")), gem_to_string_fn(NULL, _t2010, 1)), gem_string("return ")), gem_to_string_fn(NULL, _t2011, 1)), gem_string(";"));
    gem_pop_frame();
    return _t2012;
}
...
#line 961 "compiler/main.gem"
    GemVal _t2014[] = {gem_v_indent};
    GemVal gem_v_p = gem_fn_pad_for(NULL, _t2014, 1);
#line 962 "compiler/main.gem"
    GemVal _t2015 = gem_v_node;
    GemVal _t2016 = (*gem_v_compile_expr);
    GemVal _t2017[] = {gem_table_get(_t2015, gem_string("cond"))};
    GemVal gem_v_cond_r = _t2016.fn(_t2016.env, _t2017, 1);
#line 963 "compiler/main.gem"
    GemVal _t2018 = gem_v_cond_r;
    GemVal gem_v_out = gem_table_get(_t2018, gem_string("setup"));
#line 964 "compiler/main.gem"
    GemVal _t2019[] = {gem_v_p};
    GemVal _t2020 = gem_v_cond_r;
    GemVal _t2021[] = {gem_table_get(_t2020, gem_string("expr"))};
    gem_v_out = gem_add(gem_v_out, gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t2019, 1), gem_string("if (gem_truthy(")), gem_to_string_fn(NULL, _t2021, 1)), gem_string(")) {\n")));
#line 965 "compiler/main.gem"
    GemVal _t2022 = (*gem_v_compile_stmts);
    GemVal _t2023[] = {gem_table_get(gem_v_node, gem_string("then")), gem_add(gem_v_indent, gem_int(1))};
...
#line 967 "compiler/main.gem"
    GemVal _t2024[] = {gem_v_p};
        gem_v_out = gem_add(gem_v_out, gem_add(gem_to_string_fn(NULL, _t2024, 1), gem_string("} else {\n")));
#line 968 "compiler/main.gem"
    GemVal _t2025 = (*gem_v_compile_stmts);
    GemVal _t2026[] = {gem_table_get(gem_v_node, gem_string("else")), gem_add(gem_v_indent, gem_int(1))};
        gem_v_out = gem_add(gem_v_out, _t2025.fn(_t2025.env, _t2026, 2));
    }
#line 970 "compiler/main.gem"
    GemVal _t2027[] = {gem_v_p};
    gem_v_out = gem_add(gem_v_out, gem_add(gem_to_string_fn(NULL, _t2027, 1), gem_string("}")));
    GemVal _t2028 = gem_v_out;
    gem_pop_frame();
    return _t2028;
}
...
#line 977 "compiler/main.gem"
    GemVal _t2030[] = {gem_v_indent};
    GemVal gem_v_p = gem_fn_pad_for(NULL, _t2030, 1);
#line 978 "compiler/main.gem"
    GemVal _t2031 = gem_v_node;
    GemVal _t2032 = (*gem_v_compile_expr);
    GemVal _t2033[] = {gem_table_get(_t2031, gem_string("cond"))};
    GemVal gem_v_cond_r = _t2032.fn(_t2032.env, _t2033, 1);
#line 979 "compiler/main.gem"
    GemVal _t2034 = gem_v_cond_r;
    GemVal gem_v_out = gem_table_get(_t2034, gem_string("setup"));
#line 980 "compiler/main.gem"
    GemVal _t2035[] = {gem_v_p};
    GemVal _t2036 = gem_v_cond_r;
    GemVal _t2037[] = {gem_table_get(_t2036, gem_string("expr"))};
    gem_v_out = gem_add(gem_v_out, gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t2035, 1), gem_string("if (gem_truthy(")), gem_to_string_fn(NULL, _t2037, 1)), gem_string(")) {\n")));
#line 981 "compiler/main.gem"
    GemVal gem_v_then_body = gem_table_get(gem_v_node, gem_string("then"));
#line 982 "compiler/main.gem"
    GemVal _t2038[] = {gem_v_then_body};
    if (gem_truthy(gem_gt(gem_len_fn(NULL, _t2038, 1), gem_int(0)))) {
        {
#line 983 "compiler/main.gem"
            GemVal gem_v__for_i_35 = gem_int(0);
#line 983 "compiler/main.gem"
    GemVal _t2039[] = {gem_v_then_body};
            GemVal gem_v__for_limit_35 = gem_sub(gem_len_fn(NULL, _t2039, 1), gem_int(1));
#line 983 "compiler/main.gem"
            while (1) {
...
#line 984 "compiler/main.gem"
    ...
    GemVal _t2041[] = {gem_table_get(gem_v_then_body, gem_v_i), gem_add(gem_v_indent, gem_int(1))};
...
#line 986 "compiler/main.gem"
    ...
    GemVal _t2043 = (*gem_v_compile_stmt_return);
    GemVal _t2044[] = {gem_table_get(gem_v_then_body, gem_sub(gem_len_fn(NULL, _t2042, 1), gem_int(1))), gem_add(gem_v_indent, gem_int(1))};
...
#line 988 "compiler/main.gem"
    ...
    GemVal _t2046[] = {gem_v_p};
        gem_v_out = gem_add(gem_v_out, gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t2045, 1), gem_string("    gem_pop_frame();\n")), gem_to_string_fn(NULL, _t2046, 1)), gem_string("    return GEM_NIL;\n")));
    }
#line 990 "compiler/main.gem"
    if (gem_truthy(gem_neq(gem_table_get(gem_v_node, gem_string("else")), GEM_NIL))) {
#line 991 "compiler/main.gem"
    GemVal _t2047[] = {gem_v_p};
        gem_v_out = gem_add(gem_v_out, gem_add(gem_to_string_fn(NULL, _t2047, 1), gem_string("} else {\n")));
#line 992 "compiler/main.gem"
        GemVal gem_v_else_body = gem_table_get(gem_v_node, gem_string("else"));
#line 993 "compiler/main.gem"
    GemVal _t2048[] = {gem_v_else_body};
        if (gem_truthy(gem_gt(gem_len_fn(NULL, _t2048, 1), gem_int(0)))) {
            {
#line 994 "compiler/main.gem"
                GemVal gem_v__for_i_36 = gem_int(0);
#line 994 "compiler/main.gem"
    GemVal _t2049[] = {gem_v_else_body};
                GemVal gem_v__for_limit_36 = gem_sub(gem_len_fn(NULL, _t2049, 1), gem_int(1));
#line 994 "compiler/main.gem"
                while (1) {
...
#line 995 "compiler/main.gem"
    GemVal _t2050 = (*gem_v_compile_stmt);
    GemVal _t2051[] = {gem_table_get(gem_v_else_body, gem_v_i), gem_add(gem_v_indent, gem_int(1))};
...
#line 997 "compiler/main.gem"
    ...
    GemVal _t2054[] = {gem_table_get(gem_v_else_body, gem_sub(gem_len_fn(NULL, _t2052, 1), gem_int(1))), gem_add(gem_v_indent, gem_int(1))};
...
#line 1002 "compiler/main.gem"
    GemVal _t2057[] = {gem_v_p};
        gem_v_out = gem_add(gem_v_out, gem_add(gem_to_string_fn(NULL, _t2057, 1), gem_string("} else {\n")));
...
#line 1014 "compiler/main.gem"
    ...
    GemVal gem_v_out = gem_add(gem_to_string_fn(NULL, _t2067, 1), gem_string("while (1) {\n"));
#line 1015 "compiler/main.gem"
    GemVal _t2068 = gem_v_cond_r;
    if (gem_truthy(gem_neq(gem_table_get(_t2068, gem_string("setup")), gem_string("")))) {
#line 1016 "compiler/main.gem"
    GemVal _t2069 = gem_v_cond_r;
    GemVal _t2070[] = {gem_v_p};
    GemVal _t2071[] = {gem_table_get(_t2069, gem_string("setup")), gem_string("    "), gem_add(gem_to_string_fn(NULL, _t2070, 1), gem_string("    "))};
        gem_v_out = gem_add(gem_v_out, gem_str_replace_fn(NULL, _t2071, 3));
    }
#line 1018 "compiler/main.gem"
    ...
    gem_v_out = gem_add(gem_v_out, gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t2072, 1), gem_string("    if (!gem_truthy(")), gem_to_string_fn(NULL, _t2074, 1)), gem_string(")) break;\n")));
#line 1019 "compiler/main.gem"
    GemVal _t2075 = gem_v_node;
    GemVal _t2076 = (*gem_v_compile_stmts);
    GemVal _t2077[] = {gem_table_get(_t2075, gem_string("body")), gem_add(gem_v_indent, gem_int(1))};
    gem_v_out = gem_add(gem_v_out, _t2076.fn(_t2076.env, _t2077, 2));
#line 1020 "compiler/main.gem"
    GemVal _t2078[] = {gem_v_p};
    gem_v_out = gem_add(gem_v_out, gem_add(gem_to_string_fn(NULL, _t2078, 1), gem_string("}")));
    GemVal _t2079 = gem_v_out;
    gem_pop_frame();
    return _t2079;
}
...
#line 1027 "compiler/main.gem"
    GemVal _t2081[] = {gem_v_indent};
    GemVal gem_v_p = gem_fn_pad_for(NULL, _t2081, 1);
#line 1028 "compiler/main.gem"
    GemVal _t2082 = gem_v_node;
    GemVal _t2083 = (*gem_v_compile_expr);
    GemVal _t2084[] = {gem_table_get(_t2082, gem_string("target"))};
    GemVal gem_v_target_r = _t2083.fn(_t2083.env, _t2084, 1);
#line 1029 "compiler/main.gem"
    GemVal _t2085 = (*gem_v_tmp);
    GemVal gem_v_t = _t2085.fn(_t2085.env, NULL, 0);
...
#line 1031 "compiler/main.gem"
    ...
    GemVal _t2088[] = {gem_v_t};
    GemVal _t2089 = gem_v_target_r;
    GemVal _t2090[] = {gem_table_get(_t2089, gem_string("expr"))};
    gem_v_out = gem_add(gem_v_out, gem_add(gem_add(gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t2087, 1), gem_string("GemVal ")), gem_to_string_fn(NULL, _t2088, 1)), gem_string(" = ")), gem_to_string_fn(NULL, _t2090, 1)), gem_string(";\n")));
    {
#line 1032 "compiler/main.gem"
        GemVal gem_v__for_i_37 = gem_int(0);
#line 1032 "compiler/main.gem"
    GemVal _t2091 = gem_v_node;
    GemVal _t2092[] = {gem_table_get(_t2091, gem_string("whens"))};
        GemVal gem_v__for_limit_37 = gem_len_fn(NULL, _t2092, 1);
#line 1032 "compiler/main.gem"
        while (1) {
...
#line 1033 "compiler/main.gem"
    GemVal _t2093 = gem_v_node;
            GemVal gem_v_w = gem_table_get(gem_table_get(_t2093, gem_string("whens")), gem_v_i);
#line 1034 "compiler/main.gem"
    GemVal _t2094 = gem_v_w;
    GemVal _t2095 = (*gem_v_compile_expr);
    GemVal _t2096[] = {gem_table_get(_t2094, gem_string("value"))};
            GemVal gem_v_val_r = _t2095.fn(_t2095.env, _t2096, 1);
...
#line 1039 "compiler/main.gem"
    GemVal _t2097 = gem_v_val_r;
            gem_v_out = gem_add(gem_v_out, gem_table_get(_t2097, gem_string("setup")));
#line 1040 "compiler/main.gem"
    GemVal _t2098[] = {gem_v_p};
    GemVal _t2099[] = {gem_v_keyword};
    GemVal _t2100[] = {gem_v_t};
    GemVal _t2101 = gem_v_val_r;
    GemVal _t2102[] = {gem_table_get(_t2101, gem_string("expr"))};
            gem_v_out = gem_add(gem_v_out, gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t2098, 1), gem_to_string_fn(NULL, _t2099, 1)), gem_string(" (gem_truthy(gem_eq(")), gem_to_string_fn(NULL, _t2100, 1)), gem_string(", ")), gem_to_string_fn(NULL, _t2102, 1)), gem_string("))) {\n")));
#line 1041 "compiler/main.gem"
    GemVal _t2103 = gem_v_w;
    GemVal _t2104 = (*gem_v_compile_stmts);
    GemVal _t2105[] = {gem_table_get(_t2103, gem_string("body")), gem_add(gem_v_indent, gem_int(1))};
...
#line 1044 "compiler/main.gem"
    GemVal _t2106[] = {gem_v_p};
        gem_v_out = gem_add(gem_v_out, gem_add(gem_to_string_fn(NULL, _t2106, 1), gem_string("} else {\n")));
#line 1045 "compiler/main.gem"
    GemVal _t2107 = (*gem_v_compile_stmts);
    GemVal _t2108[] = {gem_table_get(gem_v_node, gem_string("else")), gem_add(gem_v_indent, gem_int(1))};
        gem_v_out = gem_add(gem_v_out, _t2107.fn(_t2107.env, _t2108, 2));
    }
#line 1047 "compiler/main.gem"
    GemVal _t2109[] = {gem_v_p};
    gem_v_out = gem_add(gem_v_out, gem_add(gem_to_string_fn(NULL, _t2109, 1), gem_string("}")));
    GemVal _t2110 = gem_v_out;
    gem_pop_frame();
    return _t2110;
}
...
#line 1054 "compiler/main.gem"
    GemVal _t2112[] = {gem_v_indent};
    GemVal gem_v_p = gem_fn_pad_for(NULL, _t2112, 1);
#line 1055 "compiler/main.gem"
    GemVal _t2113 = gem_v_node;
    GemVal _t2114 = (*gem_v_compile_expr);
    GemVal _t2115[] = {gem_table_get(_t2113, gem_string("target"))};
    GemVal gem_v_target_r = _t2114.fn(_t2114.env, _t2115, 1);
#line 1056 "compiler/main.gem"
    GemVal _t2116 = (*gem_v_tmp);
    GemVal gem_v_t = _t2116.fn(_t2116.env, NULL, 0);
#line 1057 "compiler/main.gem"
    GemVal _t2117 = gem_v_target_r;
    GemVal gem_v_out = gem_table_get(_t2117, gem_string("setup"));
#line 1058 "compiler/main.gem"
    ...
    gem_v_out = gem_add(gem_v_out, gem_add(gem_add(gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t2118, 1), gem_string("GemVal ")), gem_to_string_fn(NULL, _t2119, 1)), gem_string(" = ")), gem_to_string_fn(NULL, _t2121, 1)), gem_string(";\n")));
    {
#line 1059 "compiler/main.gem"
        GemVal gem_v__for_i_39 = gem_int(0);
#line 1059 "compiler/main.gem"
    GemVal _t2122 = gem_v_node;
    GemVal _t2123[] = {gem_table_get(_t2122, gem_string("whens"))};
        GemVal gem_v__for_limit_39 = gem_len_fn(NULL, _t2123, 1);
#line 1059 "compiler/main.gem"
        while (1) {
...
#line 1060 "compiler/main.gem"
    GemVal _t2124 = gem_v_node;
            GemVal gem_v_w = gem_table_get(gem_table_get(_t2124, gem_string("whens")), gem_v_i);
#line 1061 "compiler/main.gem"
    GemVal _t2125 = gem_v_w;
    GemVal _t2126 = (*gem_v_compile_expr);
    GemVal _t2127[] = {gem_table_get(_t2125, gem_string("value"))};
            GemVal gem_v_val_r = _t2126.fn(_t2126.env, _t2127, 1);
...
#line 1066 "compiler/main.gem"
    GemVal _t2128 = gem_v_val_r;
            gem_v_out = gem_add(gem_v_out, gem_table_get(_t2128, gem_string("setup")));
#line 1067 "compiler/main.gem"
    GemVal _t2129[] = {gem_v_p};
    GemVal _t2130[] = {gem_v_keyword};
    GemVal _t2131[] = {gem_v_t};
    GemVal _t2132 = gem_v_val_r;
    GemVal _t2133[] = {gem_table_get(_t2132, gem_string("expr"))};
            gem_v_out = gem_add(gem_v_out, gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t2129, 1), gem_to_string_fn(NULL, _t2130, 1)), gem_string(" (gem_truthy(gem_eq(")), gem_to_string_fn(NULL, _t2131, 1)), gem_string(", ")), gem_to_string_fn(NULL, _t2133, 1)), gem_string("))) {\n")));
#line 1068 "compiler/main.gem"
    GemVal _t2134 = gem_v_w;
            GemVal gem_v_body = gem_table_get(_t2134, gem_string("body"));
#line 1069 "compiler/main.gem"
    GemVal _t2135[] = {gem_v_body};
...
#line 1070 "compiler/main.gem"
    GemVal _t2136[] = {gem_v_body};
                    GemVal gem_v__for_limit_38 = gem_sub(gem_len_fn(NULL, _t2136, 1), gem_int(1));
#line 1070 "compiler/main.gem"
                    while (1) {
...
#line 1071 "compiler/main.gem"
    GemVal _t2137 = (*gem_v_compile_stmt);
    GemVal _t2138[] = {gem_table_get(gem_v_body, gem_v_j), gem_add(gem_v_indent, gem_int(1))};
...
#line 1073 "compiler/main.gem"
    ...
    GemVal _t2140 = (*gem_v_compile_stmt_return);
    GemVal _t2141[] = {gem_table_get(gem_v_body, gem_sub(gem_len_fn(NULL, _t2139, 1), gem_int(1))), gem_add(gem_v_indent, gem_int(1))};
...
#line 1075 "compiler/main.gem"
    ...
    GemVal _t2143[] = {gem_v_p};
                gem_v_out = gem_add(gem_v_out, gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t2142, 1), gem_string("    gem_pop_frame();\n")), gem_to_string_fn(NULL, _t2143, 1)), gem_string("    return GEM_NIL;\n")));
            }
        }
    }
...
#line 1079 "compiler/main.gem"
    GemVal _t2144[] = {gem_v_p};
        gem_v_out = gem_add(gem_v_out, gem_add(gem_to_string_fn(NULL, _t2144, 1), gem_string("} else {\n")));
#line 1080 "compiler/main.gem"
        GemVal gem_v_else_body = gem_table_get(gem_v_node, gem_string("else"));
#line 1081 "compiler/main.gem"
    GemVal _t2145[] = {gem_v_else_body};
...
#line 1082 "compiler/main.gem"
    GemVal _t2146[] = {gem_v_else_body};
                GemVal gem_v__for_limit_40 = gem_sub(gem_len_fn(NULL, _t2146, 1), gem_int(1));
#line 1082 "compiler/main.gem"
                while (1) {
...
#line 1083 "compiler/main.gem"
    GemVal _t2147 = (*gem_v_compile_stmt);
    GemVal _t2148[] = {gem_table_get(gem_v_else_body, gem_v_i), gem_add(gem_v_indent, gem_int(1))};
...
#line 1085 "compiler/main.gem"
    ...
    GemVal _t2150 = (*gem_v_compile_stmt_return);
    GemVal _t2151[] = {gem_table_get(gem_v_else_body, gem_sub(gem_len_fn(NULL, _t2149, 1), gem_int(1))), gem_add(gem_v_indent, gem_int(1))};
...
#line 1090 "compiler/main.gem"
    GemVal _t2154[] = {gem_v_p};
        gem_v_out = gem_add(gem_v_out, gem_add(gem_to_string_fn(NULL, _t2154, 1), gem_string("} else {\n")));
...
#line 1093 "compiler/main.gem"
    ...
    gem_v_out = gem_add(gem_v_out, gem_add(gem_to_string_fn(NULL, _t2157, 1), gem_string("}")));
    GemVal _t2158 = gem_v_out;
    gem_pop_frame();
    return _t2158;
}
...
#line 1100 "compiler/main.gem"
    ...
    GemVal gem_v_name = gem_table_get(_t2160, gem_string("name"));
#line 1101 "compiler/main.gem"
    GemVal _t2161 = gem_v_node;
    GemVal gem_v_params = gem_table_get(_t2161, gem_string("params"));
#line 1102 "compiler/main.gem"
    GemVal _t2162 = gem_v_node;
    GemVal gem_v_ret_type = gem_table_get(_t2162, gem_string("ret_type"));
#line 1104 "compiler/main.gem"
    GemVal _t2163[] = {gem_v_name};
    GemVal gem_v_lines = gem_add(gem_add(gem_string("static GemVal gem_fn_"), gem_to_string_fn(NULL, _t2163, 1)), gem_string("(void *_env, GemVal *args, int argc) {\n"));
#line 1106 "compiler/main.gem"
    GemVal _t2164 = gem_table_new();
    GemVal gem_v_c_args = _t2164;
    {
#line 1107 "compiler/main.gem"
        GemVal gem_v__for_i_41 = gem_int(0);
#line 1107 "compiler/main.gem"
    GemVal _t2165[] = {gem_v_params};
        GemVal gem_v__for_limit_41 = gem_len_fn(NULL, _t2165, 1);
#line 1107 "compiler/main.gem"
        while (1) {
...
#line 1111 "compiler/main.gem"
    ...
    GemVal _t2167[] = {gem_v_i};
                gem_v_lines = gem_add(gem_v_lines, gem_add(gem_add(gem_add(gem_add(gem_string("    int64_t _p"), gem_to_string_fn(NULL, _t2166, 1)), gem_string(" = args[")), gem_to_string_fn(NULL, _t2167, 1)), gem_string("].ival;\n")));
#line 1112 "compiler/main.gem"
    GemVal _t2168[] = {gem_v_i};
    GemVal _t2169[] = {gem_v_c_args, gem_add(gem_string("_p"), gem_to_string_fn(NULL, _t2168, 1))};
                (void)(gem_push_fn(NULL, _t2169, 2));
            } else {
...
#line 1114 "compiler/main.gem"
    ...
    GemVal _t2171[] = {gem_v_i};
                    gem_v_lines = gem_add(gem_v_lines, gem_add(gem_add(gem_add(gem_add(gem_string("    double _p"), gem_to_string_fn(NULL, _t2170, 1)), gem_string(" = args[")), gem_to_string_fn(NULL, _t2171, 1)), gem_string("].fval;\n")));
#line 1115 "compiler/main.gem"
    GemVal _t2172[] = {gem_v_i};
    GemVal _t2173[] = {gem_v_c_args, gem_add(gem_string("_p"), gem_to_string_fn(NULL, _t2172, 1))};
                    (void)(gem_push_fn(NULL, _t2173, 2));
                } else {
...
#line 1117 "compiler/main.gem"
    ...
    GemVal _t2175[] = {gem_v_i};
                        gem_v_lines = gem_add(gem_v_lines, gem_add(gem_add(gem_add(gem_add(gem_string("    char* _p"), gem_to_string_fn(NULL, _t2174, 1)), gem_string(" = args[")), gem_to_string_fn(NULL, _t2175, 1)), gem_string("].sval;\n")));
#line 1118 "compiler/main.gem"
    GemVal _t2176[] = {gem_v_i};
    GemVal _t2177[] = {gem_v_c_args, gem_add(gem_string("_p"), gem_to_string_fn(NULL, _t2176, 1))};
                        (void)(gem_push_fn(NULL, _t2177, 2));
                    } else {
...
#line 1120 "compiler/main.gem"
    ...
    GemVal _t2179[] = {gem_v_i};
                            gem_v_lines = gem_add(gem_v_lines, gem_add(gem_add(gem_add(gem_add(gem_string("    int _p"), gem_to_string_fn(NULL, _t2178, 1)), gem_string(" = args[")), gem_to_string_fn(NULL, _t2179, 1)), gem_string("].bval;\n")));
#line 1121 "compiler/main.gem"
    GemVal _t2180[] = {gem_v_i};
    GemVal _t2181[] = {gem_v_c_args, gem_add(gem_string("_p"), gem_to_string_fn(NULL, _t2180, 1))};
...
#line 1123 "compiler/main.gem"
    ...
    GemVal _t2183[] = {gem_v_i};
                                gem_v_lines = gem_add(gem_v_lines, gem_add(gem_add(gem_add(gem_add(gem_string("    void* _p"), gem_to_string_fn(NULL, _t2182, 1)), gem_string(" = (void*)(intptr_t)args[")), gem_to_string_fn(NULL, _t2183, 1)), gem_string("].ival;\n")));
#line 1124 "compiler/main.gem"
    GemVal _t2184[] = {gem_v_i};
    GemVal _t2185[] = {gem_v_c_args, gem_add(gem_string("_p"), gem_to_string_fn(NULL, _t2184, 1))};
...
#line 1126 "compiler/main.gem"
    ...
    GemVal _t2187[] = {gem_v_c_args, gem_add(gem_add(gem_string("args["), gem_to_string_fn(NULL, _t2186, 1)), gem_string("]"))};
                                    (void)(gem_push_fn(NULL, _t2187, 2));
                                } else {
#line 1128 "compiler/main.gem"
    GemVal _t2188[] = {gem_v_i};
    GemVal _t2189[] = {gem_v_c_args, gem_add(gem_add(gem_string("args["), gem_to_string_fn(NULL, _t2188, 1)), gem_string("]"))};
                                    (void)(gem_push_fn(NULL, _t2189, 2));
                                }
                            }
                        }
                    }
...
#line 1134 "compiler/main.gem"
    GemVal _t2190[] = {gem_v_c_args};
        GemVal gem_v__for_limit_42 = gem_len_fn(NULL, _t2190, 1);
#line 1134 "compiler/main.gem"
        while (1) {
...
#line 1141 "compiler/main.gem"
    GemVal _t2191[] = {gem_v_name};
    GemVal _t2192[] = {gem_v_call_args};
    GemVal gem_v_call_expr = gem_add(gem_add(gem_add(gem_to_string_fn(NULL, _t2191, 1), gem_string("(")), gem_to_string_fn(NULL, _t2192, 1)), gem_string(")"));
...
#line 1144 "compiler/main.gem"
    GemVal _t2193[] = {gem_v_call_expr};
        gem_v_lines = gem_add(gem_v_lines, gem_add(gem_add(gem_string("    "), gem_to_string_fn(NULL, _t2193, 1)), gem_string(";\n")));
...
#line 1147 "compiler/main.gem"
    GemVal _t2194[] = {gem_v_call_expr};
            gem_v_lines = gem_add(gem_v_lines, gem_add(gem_add(gem_string("    return "), gem_to_string_fn(NULL, _t2194, 1)), gem_string(";\n")));
        } else {
...
#line 1149 "compiler/main.gem"
    GemVal _t2195[] = {gem_v_call_expr};
                gem_v_lines = gem_add(gem_v_lines, gem_add(gem_add(gem_string("    int64_t _ret = "), gem_to_string_fn(NULL, _t2195, 1)), gem_string(";\n")));
...
#line 1152 "compiler/main.gem"
    GemVal _t2196[] = {gem_v_call_expr};
                    gem_v_lines = gem_add(gem_v_lines, gem_add(gem_add(gem_string("    double _ret = "), gem_to_string_fn(NULL, _t2196, 1)), gem_string(";\n")));
...
#line 1155 "compiler/main.gem"
    GemVal _t2197[] = {gem_v_call_expr};
                        gem_v_lines = gem_add(gem_v_lines, gem_add(gem_add(gem_string("    char* _ret = "), gem_to_string_fn(NULL, _t2197, 1)), gem_string(";\n")));
...
#line 1158 "compiler/main.gem"
    GemVal _t2198[] = {gem_v_call_expr};
                            gem_v_lines = gem_add(gem_v_lines, gem_add(gem_add(gem_string("    int _ret = "), gem_to_string_fn(NULL, _t2198, 1)), gem_string(";\n")));
...
#line 1161 "compiler/main.gem"
    GemVal _t2199[] = {gem_v_call_expr};
                                gem_v_lines = gem_add(gem_v_lines, gem_add(gem_add(gem_string("    void *_ret = "), gem_to_string_fn(NULL, _t2199, 1)), gem_string(";\n")));
...
#line 1171 "compiler/main.gem"
    GemVal _t2201[] = {gem_v_name};
    GemVal _t2202[] = {(*gem_v_forward_decls), gem_add(gem_add(gem_string("static GemVal gem_fn_"), gem_to_string_fn(NULL, _t2201, 1)), gem_string("(void *_env, GemVal *args, int argc);"))};
    (void)(gem_push_fn(NULL, _t2202, 2));
    GemVal _t2203 = gem_v_lines;
    gem_pop_frame();
    return _t2203;
}
...
#line 1180 "compiler/main.gem"
    ...
    GemVal gem_v_body = gem_table_get(_t2206, gem_string("body"));
#line 1181 "compiler/main.gem"
    GemVal _t2207 = gem_v_node;
    GemVal gem_v_name = gem_table_get(_t2207, gem_string("name"));
#line 1184 "compiler/main.gem"
    GemVal _t2208[] = {gem_v_params};
    GemVal gem_v_scope_vars = gem_fn_sorted_array_to_set(NULL, _t2208, 1);
    {
#line 1185 "compiler/main.gem"
        GemVal gem_v__for_i_44 = gem_int(0);
#line 1185 "compiler/main.gem"
    GemVal _t2209[] = {gem_v_body};
        GemVal gem_v__for_limit_44 = gem_len_fn(NULL, _t2209, 1);
#line 1185 "compiler/main.gem"
        while (1) {
...
#line 1186 "compiler/main.gem"
    ...
    GemVal _t2212;
    if (!gem_truthy(gem_eq(gem_type_fn(NULL, _t2210, 1), gem_string("table")))) {
        _t2212 = gem_eq(gem_type_fn(NULL, _t2210, 1), gem_string("table"));
    } else {
        GemVal _t2211 = gem_table_get(gem_v_body, gem_v_i);
        _t2212 = gem_eq(gem_table_get(_t2211, gem_string("tag")), gem_string("let"));
    }
            if (gem_truthy(_t2212)) {
#line 1187 "compiler/main.gem"
    GemVal _t2213 = gem_table_get(gem_v_body, gem_v_i);
    GemVal _t2214[] = {gem_v_scope_vars, gem_table_get(_t2213, gem_string("name"))};
                (void)(gem_fn_set_add(NULL, _t2214, 2));
            }
#line 1189 "compiler/main.gem"
    ...
    if (!gem_truthy(gem_eq(gem_type_fn(NULL, _t2215, 1), gem_string("table")))) {
        _t2217 = gem_eq(gem_type_fn(NULL, _t2215, 1), gem_string("table"));
    } else {
        GemVal _t2216 = gem_table_get(gem_v_body, gem_v_i);
        _t2217 = gem_eq(gem_table_get(_t2216, gem_string("tag")), gem_string("block"));
    }
...
#line 1190 "compiler/main.gem"
    ...
    GemVal _t2219[] = {gem_table_get(_t2218, gem_string("stmts"))};
...
#line 1191 "compiler/main.gem"
    ...
    GemVal _t2221[] = {gem_table_get(gem_table_get(_t2220, gem_string("stmts")), gem_v_j)};
    GemVal _t2224;
    if (!gem_truthy(gem_eq(gem_type_fn(NULL, _t2221, 1), gem_string("table")))) {
        _t2224 = gem_eq(gem_type_fn(NULL, _t2221, 1), gem_string("table"));
    } else {
        GemVal _t2222 = gem_table_get(gem_v_body, gem_v_i);
        GemVal _t2223 = gem_table_get(gem_table_get(_t2222, gem_string("stmts")), gem_v_j);
        _t2224 = gem_eq(gem_table_get(_t2223, gem_string("tag")), gem_string("let"));
    }
...
#line 1192 "compiler/main.gem"
    ...
    GemVal _t2227[] = {gem_v_scope_vars, gem_table_get(_t2226, gem_string("name"))};
                            (void)(gem_fn_set_add(NULL, _t2227, 2));
                        }
                    }
                }
            }
...
#line 1197 "compiler/main.gem"
    GemVal _t2228 = (*gem_v_find_captured_in_scope);
    GemVal _t2229[] = {gem_v_body, gem_v_scope_vars};
    GemVal gem_v_captured = _t2228.fn(_t2228.env, _t2229, 2);
...
#line 1202 "compiler/main.gem"
    GemVal _t2230[] = {gem_v_name};
    GemVal gem_v_lines = gem_add(gem_add(gem_string("static GemVal gem_fn_"), gem_to_string_fn(NULL, _t2230, 1)), gem_string("(void *_env, GemVal *args, int argc) {\n"));
#line 1205 "compiler/main.gem"
    GemVal _t2231 = gem_v_node;
    if (gem_truthy(gem_neq(gem_table_get(_t2231, gem_string("line")), GEM_NIL))) {
#line 1206 "compiler/main.gem"
    GemVal _t2232 = gem_v_node;
    GemVal _t2233[] = {gem_table_get(_t2232, gem_string("line"))};
    GemVal _t2234[] = {(*gem_v_source_name)};
    GemVal _t2235[] = {gem_fn_escape_c_string(NULL, _t2234, 1)};
        gem_v_lines = gem_add(gem_v_lines, gem_add(gem_add(gem_add(gem_add(gem_string("#line "), gem_to_string_fn(NULL, _t2233, 1)), gem_string(" \"")), gem_to_string_fn(NULL, _t2235, 1)), gem_string("\"\n")));
    }
    {
#line 1210 "compiler/main.gem"
        GemVal gem_v__for_i_45 = gem_int(0);
#line 1210 "compiler/main.gem"
    GemVal _t2236[] = {gem_v_params};
        GemVal gem_v__for_limit_45 = gem_len_fn(NULL, _t2236, 1);
#line 1210 "compiler/main.gem"
        while (1) {
...
#line 1211 "compiler/main.gem"
    GemVal _t2237 = (*gem_v_mangle);
    GemVal _t2238[] = {gem_table_get(gem_v_params, gem_v_i)};
            GemVal gem_v_mp = _t2237.fn(_t2237.env, _t2238, 1);
#line 1212 "compiler/main.gem"
    GemVal _t2239[] = {gem_v_captured, gem_table_get(gem_v_params, gem_v_i)};
            if (gem_truthy(gem_fn_set_contains(NULL, _t2239, 2))) {
#line 1213 "compiler/main.gem"
    GemVal _t2240[] = {gem_v_mp};
                gem_v_lines = gem_add(gem_v_lines, gem_add(gem_add(gem_string("    GemVal *"), gem_to_string_fn(NULL, _t2240, 1)), gem_string(" = GC_MALLOC(sizeof(GemVal));\n")));
#line 1214 "compiler/main.gem"
    GemVal _t2241[] = {gem_v_mp};
    GemVal _t2242[] = {gem_v_i};
    GemVal _t2243[] = {gem_v_i};
                gem_v_lines = gem_add(gem_v_lines, gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_string("    *"), gem_to_string_fn(NULL, _t2241, 1)), gem_string(" = (argc > ")), gem_to_string_fn(NULL, _t2242, 1)), gem_string(") ? args[")), gem_to_string_fn(NULL, _t2243, 1)), gem_string("] : GEM_NIL;\n")));
            } else {
#line 1216 "compiler/main.gem"
    GemVal _t2244[] = {gem_v_mp};
    GemVal _t2245[] = {gem_v_i};
    GemVal _t2246[] = {gem_v_i};
                gem_v_lines = gem_add(gem_v_lines, gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_string("    GemVal "), gem_to_string_fn(NULL, _t2244, 1)), gem_string(" = (argc > ")), gem_to_string_fn(NULL, _t2245, 1)), gem_string(") ? args[")), gem_to_string_fn(NULL, _t2246, 1)), gem_string("] : GEM_NIL;\n")));
            }
        }
    }
...
#line 1221 "compiler/main.gem"
    ...
    if (gem_truthy(gem_neq(gem_table_get(_t2247, gem_string("line")), GEM_NIL))) {
#line 1222 "compiler/main.gem"
    GemVal _t2248 = gem_v_node;
        gem_v_fn_line = gem_table_get(_t2248, gem_string("line"));
    }
#line 1224 "compiler/main.gem"
    GemVal _t2249[] = {gem_v_name};
    GemVal _t2250[] = {gem_fn_escape_c_string(NULL, _t2249, 1)};
    GemVal _t2251[] = {(*gem_v_source_name)};
    GemVal _t2252[] = {gem_fn_escape_c_string(NULL, _t2251, 1)};
    GemVal _t2253[] = {gem_v_fn_line};
    gem_v_lines = gem_add(gem_v_lines, gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_string("    gem_push_frame(\""), gem_to_string_fn(NULL, _t2250, 1)), gem_string("\", \"")), gem_to_string_fn(NULL, _t2252, 1)), gem_string("\", ")), gem_to_string_fn(NULL, _t2253, 1)), gem_string(");\n")));
#line 1227 "compiler/main.gem"
    GemVal _t2254[] = {gem_v_body};
    if (gem_truthy(gem_gt(gem_len_fn(NULL, _t2254, 1), gem_int(0)))) {
        {
#line 1228 "compiler/main.gem"
            GemVal gem_v__for_i_46 = gem_int(0);
#line 1228 "compiler/main.gem"
    GemVal _t2255[] = {gem_v_body};
            GemVal gem_v__for_limit_46 = gem_sub(gem_len_fn(NULL, _t2255, 1), gem_int(1));
#line 1228 "compiler/main.gem"
            while (1) {
...
#line 1229 "compiler/main.gem"
    GemVal _t2256 = (*gem_v_compile_stmt);
    GemVal _t2257[] = {gem_table_get(gem_v_body, gem_v_i), gem_int(1)};
...
#line 1231 "compiler/main.gem"
    ...
    GemVal _t2259 = (*gem_v_compile_stmt_return);
    GemVal _t2260[] = {gem_table_get(gem_v_body, gem_sub(gem_len_fn(NULL, _t2258, 1), gem_int(1))), gem_int(1)};
...
#line 1244 "compiler/main.gem"
    ...
    GemVal gem_v_params = gem_table_get(_t2263, gem_string("params"));
#line 1245 "compiler/main.gem"
    GemVal _t2264 = gem_v_node;
    GemVal gem_v_body = gem_table_get(_t2264, gem_string("body"));
#line 1246 "compiler/main.gem"
    GemVal _t2265 = (*gem_v_anon_name);
    GemVal gem_v_name = _t2265.fn(_t2265.env, NULL, 0);
#line 1249 "compiler/main.gem"
    GemVal _t2266[] = {gem_v_params};
    GemVal gem_v_inner_scope = gem_fn_sorted_array_to_set(NULL, _t2266, 1);
    {
#line 1250 "compiler/main.gem"
        GemVal gem_v__for_i_48 = gem_int(0);
#line 1250 "compiler/main.gem"
    GemVal _t2267[] = {gem_v_body};
        GemVal gem_v__for_limit_48 = gem_len_fn(NULL, _t2267, 1);
#line 1250 "compiler/main.gem"
        while (1) {
...
#line 1251 "compiler/main.gem"
    ...
    GemVal _t2270;
    if (!gem_truthy(gem_eq(gem_type_fn(NULL, _t2268, 1), gem_string("table")))) {
        _t2270 = gem_eq(gem_type_fn(NULL, _t2268, 1), gem_string("table"));
    } else {
        GemVal _t2269 = gem_table_get(gem_v_body, gem_v_i);
        _t2270 = gem_eq(gem_table_get(_t2269, gem_string("tag")), gem_string("let"));
    }
            if (gem_truthy(_t2270)) {
#line 1252 "compiler/main.gem"
    GemVal _t2271 = gem_table_get(gem_v_body, gem_v_i);
    GemVal _t2272[] = {gem_v_inner_scope, gem_table_get(_t2271, gem_string("name"))};
...
#line 1254 "compiler/main.gem"
    ...
    if (!gem_truthy(gem_eq(gem_type_fn(NULL, _t2273, 1), gem_string("table")))) {
        ...
        _t2275 = gem_eq(gem_table_get(_t2274, gem_string("tag")), gem_string("block"));
    }
...
#line 1255 "compiler/main.gem"
    ...
    GemVal _t2277[] = {gem_table_get(_t2276, gem_string("stmts"))};
                    GemVal gem_v__for_limit_47 = gem_len_fn(NULL, _t2277, 1);
#line 1255 "compiler/main.gem"
                    while (1) {
...
#line 1256 "compiler/main.gem"
    ...
    GemVal _t2279[] = {gem_table_get(gem_table_get(_t2278, gem_string("stmts")), gem_v_j)};
    GemVal _t2282;
    if (!gem_truthy(gem_eq(gem_type_fn(NULL, _t2279, 1), gem_string("table")))) {
        _t2282 = gem_eq(gem_type_fn(NULL, _t2279, 1), gem_string("table"));
    } else {
        GemVal _t2280 = gem_table_get(gem_v_body, gem_v_i);
        GemVal _t2281 = gem_table_get(gem_table_get(_t2280, gem_string("stmts")), gem_v_j);
        _t2282 = gem_eq(gem_table_get(_t2281, gem_string("tag")), gem_string("let"));
    }
...
#line 1257 "compiler/main.gem"
    ...
    GemVal _t2285[] = {gem_v_inner_scope, gem_table_get(_t2284, gem_string("name"))};
                            (void)(gem_fn_set_add(NULL, _t2285, 2));
                        }
                    }
                }
            }
...
#line 1262 "compiler/main.gem"
    GemVal _t2286 = (*gem_v_find_captured_in_scope);
    GemVal _t2287[] = {gem_v_body, gem_v_inner_scope};
    GemVal gem_v_inner_captured = _t2286.fn(_t2286.env, _t2287, 2);
#line 1264 "compiler/main.gem"
    GemVal gem_v_saved_boxed = (*gem_v_boxed_vars);
#line 1265 "compiler/main.gem"
    GemVal _t2288[] = {gem_v_captures};
    GemVal _t2289[] = {gem_v_inner_captured, gem_fn_sorted_array_to_set(NULL, _t2288, 1)};
    *gem_v_boxed_vars = gem_fn_set_union(NULL, _t2289, 2);
#line 1268 "compiler/main.gem"
    GemVal _t2290[] = {gem_v_name};
    GemVal gem_v_struct_name = gem_add(gem_string("_closure_"), gem_to_string_fn(NULL, _t2290, 1));
#line 1269 "compiler/main.gem"
    GemVal _t2291[] = {gem_v_struct_name};
    GemVal gem_v_struct_def = gem_add(gem_add(gem_string("struct "), gem_to_string_fn(NULL, _t2291, 1)), gem_string(" {\n"));
    {
...
#line 1270 "compiler/main.gem"
        while (1) {
            GemVal _t2292[] = {gem_v__for_items_49};
            if (!gem_truthy(gem_lt(gem_v__for_i_49, gem_len_fn(NULL, _t2292, 1)))) break;
#line 1270 "compiler/main.gem"
...
#line 1271 "compiler/main.gem"
    GemVal _t2293 = (*gem_v_mangle);
    GemVal _t2294[] = {gem_v_cap};
    GemVal _t2295[] = {_t2293.fn(_t2293.env, _t2294, 1)};
            gem_v_struct_def = gem_add(gem_v_struct_def, gem_add(gem_add(gem_string("    GemVal *"), gem_to_string_fn(NULL, _t2295, 1)), gem_string(";\n")));
        }
    }
#line 1273 "compiler/main.gem"
    gem_v_struct_def = gem_add(gem_v_struct_def, gem_string("};\n"));
#line 1276 "compiler/main.gem"
    GemVal _t2296[] = {gem_v_name};
    GemVal gem_v_lines = gem_add(gem_add(gem_string("static GemVal "), gem_to_string_fn(NULL, _t2296, 1)), gem_string("(void *_env, GemVal *args, int argc) {\n"));
#line 1277 "compiler/main.gem"
    GemVal _t2297[] = {gem_v_captures};
    if (gem_truthy(gem_gt(gem_len_fn(NULL, _t2297, 1), gem_int(0)))) {
#line 1278 "compiler/main.gem"
    GemVal _t2298[] = {gem_v_struct_name};
    GemVal _t2299[] = {gem_v_struct_name};
        gem_v_lines = gem_add(gem_v_lines, gem_add(gem_add(gem_add(gem_add(gem_string("    struct "), gem_to_string_fn(NULL, _t2298, 1)), gem_string(" *_cls = (struct ")), gem_to_string_fn(NULL, _t2299, 1)), gem_string(" *)_env;\n")));
        {
...
#line 1279 "compiler/main.gem"
            while (1) {
                GemVal _t2300[] = {gem_v__for_items_50};
                if (!gem_truthy(gem_lt(gem_v__for_i_50, gem_len_fn(NULL, _t2300, 1)))) break;
#line 1279 "compiler/main.gem"
...
#line 1280 "compiler/main.gem"
    GemVal _t2301 = (*gem_v_mangle);
    GemVal _t2302[] = {gem_v_cap};
                GemVal gem_v_mc = _t2301.fn(_t2301.env, _t2302, 1);
#line 1281 "compiler/main.gem"
    GemVal _t2303[] = {gem_v_mc};
    GemVal _t2304[] = {gem_v_mc};
                gem_v_lines = gem_add(gem_v_lines, gem_add(gem_add(gem_add(gem_add(gem_string("    GemVal *"), gem_to_string_fn(NULL, _t2303, 1)), gem_string(" = _cls->")), gem_to_string_fn(NULL, _t2304, 1)), gem_string(";\n")));
            }
        }
    }
    {
...
#line 1286 "compiler/main.gem"
    GemVal _t2305[] = {gem_v_params};
        GemVal gem_v__for_limit_51 = gem_len_fn(NULL, _t2305, 1);
#line 1286 "compiler/main.gem"
        while (1) {
...
#line 1287 "compiler/main.gem"
    GemVal _t2306 = (*gem_v_mangle);
    GemVal _t2307[] = {gem_table_get(gem_v_params, gem_v_i)};
            GemVal gem_v_mp = _t2306.fn(_t2306.env, _t2307, 1);
#line 1288 "compiler/main.gem"
    GemVal _t2308[] = {gem_v_inner_captured, gem_table_get(gem_v_params, gem_v_i)};
            if (gem_truthy(gem_fn_set_contains(NULL, _t2308, 2))) {
#line 1289 "compiler/main.gem"
    GemVal _t2309[] = {gem_v_mp};
                gem_v_lines = gem_add(gem_v_lines, gem_add(gem_add(gem_string("    GemVal *"), gem_to_string_fn(NULL, _t2309, 1)), gem_string(" = GC_MALLOC(sizeof(GemVal));\n")));
#line 1290 "compiler/main.gem"
    GemVal _t2310[] = {gem_v_mp};
    GemVal _t2311[] = {gem_v_i};
    GemVal _t2312[] = {gem_v_i};
                gem_v_lines = gem_add(gem_v_lines, gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_string("    *"), gem_to_string_fn(NULL, _t2310, 1)), gem_string(" = (argc > ")), gem_to_string_fn(NULL, _t2311, 1)), gem_string(") ? args[")), gem_to_string_fn(NULL, _t2312, 1)), gem_string("] : GEM_NIL;\n")));
            } else {
#line 1292 "compiler/main.gem"
    GemVal _t2313[] = {gem_v_mp};
    GemVal _t2314[] = {gem_v_i};
    GemVal _t2315[] = {gem_v_i};
                gem_v_lines = gem_add(gem_v_lines, gem_add(gem_add(gem_add(gem_add(gem_add(gem_add(gem_string("    GemVal "), gem_to_string_fn(NULL, _t2313, 1)), gem_string(" = (argc > ")), gem_to_string_fn(NULL, _t2314, 1)), gem_string(") ? args[")), gem_to_string_fn(NULL, _t2315, 1)), gem_string("] : GEM_NIL;\n")));
            }
        }
    }
#line 1296 "compiler/main.gem"
    GemVal _t2316[] = {gem_v_name};
    GemVal _t2317[] = {gem_fn_escape_c_string(NULL, _t2316, 1)};
    GemVal _t2318[] = {(*gem_v_source_name)};
    GemVal _t2319[] = {gem_fn_escape_c_string(NULL, _t2318, 1)};
    gem_v_lines = gem_add(gem_v_lines, gem_add(gem_add(gem_add(gem_add(gem_string("    gem_push_frame(\""), gem_to_string_fn(NULL, _t2317, 1)), gem_string("\", \"")), gem_to_string_fn(NULL, _t2319, 1)), gem_string("\", 0);\n")));
#line 1298 "compiler/main.gem"
    GemVal _t2320[] = {gem_v_body};
    if (gem_truthy(gem_gt(gem_len_fn(NULL, _t2320, 1), gem_int(0)))) {
        {
#line 1299 "compiler/main.gem"
            GemVal gem_v__for_i_52 = gem_int(0);
#line 1299 "compiler/main.gem"
    GemVal _t2321[] = {gem_v_body};
            GemVal gem_v__for_limit_52 = gem_sub(gem_len_fn(NULL, _t2321, 1), gem_int(1));
#line 1299 "compiler/main.gem"
            while (1) {
...
#line 1300 "compiler/main.gem"
    GemVal _t2322 = (*gem_v_compile_stmt);
    GemVal _t2323[] = {gem_table_get(gem_v_body, gem_v_i), gem_int(1)};
...
#line 1302 "compiler/main.gem"
    ...
    GemVal _t2325 = (*gem_v_compile_stmt_return);
    GemVal _t2326[] = {gem_table_get(gem_v_body, gem_sub(gem_len_fn(NULL, _t2324, 1), gem_int(1))), gem_int(1)};
...
#line 1311 "compiler/main.gem"
    GemVal _t2327[] = {(*gem_v_functions), gem_add(gem_v_struct_def, gem_v_lines)};
    (void)(gem_push_fn(NULL, _t2327, 2));
    GemVal _t2328 = gem_table_new();
    gem_table_set(_t2328, gem_string("fn_name"), gem_v_name);
    gem_table_set(_t2328, gem_string("struct_name"), gem_v_struct_name);
    gem_table_set(_t2328, gem_string("captures"), gem_v_captures);
...
#line 1320 "compiler/main.gem"
    ...
    GemVal gem_v_fn_defs = _t2331;
#line 1321 "compiler/main.gem"
    GemVal _t2332 = gem_table_new();
    GemVal gem_v_extern_fns_list = _t2332;
#line 1322 "compiler/main.gem"
    GemVal _t2333 = gem_table_new();
    GemVal gem_v_extern_includes = _t2333;
#line 1323 "compiler/main.gem"
    GemVal _t2334 = gem_table_new();
    GemVal gem_v_top_stmts = _t2334;
    {
#line 1325 "compiler/main.gem"
    GemVal _t2335 = gem_v_ast;
        GemVal gem_v__for_items_53 = gem_table_get(_t2335, gem_string("stmts"));
#line 1325 "compiler/main.gem"
        GemVal gem_v__for_i_53 = gem_int(0);
#line 1325 "compiler/main.gem"
        while (1) {
            GemVal _t2336[] = {gem_v__for_items_53};
            if (!gem_truthy(gem_lt(gem_v__for_i_53, gem_len_fn(NULL, _t2336, 1)))) break;
#line 1325 "compiler/main.gem"
...
#line 1326 "compiler/main.gem"
    GemVal _t2337 = gem_v_s;
            if (gem_truthy(gem_eq(gem_table_get(_t2337, gem_string("tag")), gem_string("fn_def")))) {
#line 1327 "compiler/main.gem"
    GemVal _t2338[] = {gem_v_fn_defs, gem_v_s};
                (void)(gem_push_fn(NULL, _t2338, 2));
            } else {
#line 1328 "compiler/main.gem"
    GemVal _t2339 = gem_v_s;
                if (gem_truthy(gem_eq(gem_table_get(_t2339, gem_string("tag")), gem_string("extern_fn")))) {
#line 1329 "compiler/main.gem"
    GemVal _t2340[] = {gem_v_extern_fns_list, gem_v_s};
                    (void)(gem_push_fn(NULL, _t2340, 2));
                } else {
#line 1330 "compiler/main.gem"
    GemVal _t2341 = gem_v_s;
                    if (gem_truthy(gem_eq(gem_table_get(_t2341, gem_string("tag")), gem_string("extern_include")))) {
#line 1331 "compiler/main.gem"
    GemVal _t2342[] = {gem_v_extern_includes, gem_v_s};
                        (void)(gem_push_fn(NULL, _t2342, 2));
                    } else {
#line 1333 "compiler/main.gem"
    GemVal _t2343[] = {gem_v_top_stmts, gem_v_s};
...
#line 1338 "compiler/main.gem"
        while (1) {
            GemVal _t2344[] = {gem_v__for_items_54};
            if (!gem_truthy(gem_lt(gem_v__for_i_54, gem_len_fn(NULL, _t2344, 1)))) break;
#line 1338 "compiler/main.gem"
...
#line 1343 "compiler/main.gem"
        while (1) {
            GemVal _t2347[] = {gem_v__for_items_55};
            if (!gem_truthy(gem_lt(gem_v__for_i_55, gem_len_fn(NULL, _t2347, 1)))) break;
#line 1343 "compiler/main.gem"
...
#line 1345 "compiler/main.gem"
    ...
    GemVal _t2351[] = {gem_table_get(_t2350, gem_string("name"))};
            GemVal gem_v_decl = gem_add(gem_add(gem_string("static GemVal gem_fn_"), gem_to_string_fn(NULL, _t2351, 1)), gem_string("(void *_env, GemVal *args, int argc);"));
#line 1346 "compiler/main.gem"
    GemVal _t2352[] = {(*gem_v_forward_decls), gem_v_decl};
            (void)(gem_push_fn(NULL, _t2352, 2));
        }
    }
    {
...
#line 1350 "compiler/main.gem"
        while (1) {
            GemVal _t2353[] = {gem_v__for_items_56};
            if (!gem_truthy(gem_lt(gem_v__for_i_56, gem_len_fn(NULL, _t2353, 1)))) break;
#line 1350 "compiler/main.gem"
...
#line 1351 "compiler/main.gem"
    GemVal _t2354 = (*gem_v_compile_extern_fn);
    GemVal _t2355[] = {gem_v_ef};
    GemVal _t2356[] = {(*gem_v_functions), _t2354.fn(_t2354.env, _t2355, 1)};
            (void)(gem_push_fn(NULL, _t2356, 2));
        }
    }
    {
...
#line 1355 "compiler/main.gem"
        while (1) {
            GemVal _t2357[] = {gem_v__for_items_57};
            if (!gem_truthy(gem_lt(gem_v__for_i_57, gem_len_fn(NULL, _t2357, 1)))) break;
#line 1355 "compiler/main.gem"
...
#line 1356 "compiler/main.gem"
    GemVal _t2358 = (*gem_v_compile_fn);
    GemVal _t2359[] = {gem_v_fd};
    GemVal _t2360[] = {(*gem_v_functions), _t2358.fn(_t2358.env, _t2359, 1)};
...
#line 1361 "compiler/main.gem"
    ...
    GemVal _t2362 = (*gem_v_find_captured_in_scope);
    GemVal _t2363[] = {gem_v_top_stmts, _t2361};
    *gem_v_boxed_vars = _t2362.fn(_t2362.env, _t2363, 2);
#line 1362 "compiler/main.gem"
    GemVal _t2364 = (*gem_v_compile_stmts);
    GemVal _t2365[] = {gem_v_top_stmts, gem_int(1)};
    GemVal gem_v_main_body = _t2364.fn(_t2364.env, _t2365, 2);
...
#line 1366 "compiler/main.gem"
        while (1) {
            GemVal _t2366[] = {gem_v__for_items_58};
            if (!gem_truthy(gem_lt(gem_v__for_i_58, gem_len_fn(NULL, _t2366, 1)))) break;
#line 1366 "compiler/main.gem"
...
#line 1367 "compiler/main.gem"
    GemVal _t2367 = gem_v_fd;
            if (gem_truthy(gem_eq(gem_table_get(_t2367, gem_string("name")), gem_string("main")))) {
...
#line 1373 "compiler/main.gem"
    GemVal _t2368[] = {(*gem_v_source_name)};
    GemVal _t2369[] = {gem_fn_escape_c_string(NULL, _t2368, 1)};
    gem_v_main_c = gem_add(gem_v_main_c, gem_add(gem_add(gem_string("    gem_push_frame(\"main\", \""), gem_to_string_fn(NULL, _t2369, 1)), gem_string("\", 0);\n")));
...
#line 1386 "compiler/main.gem"
        while (1) {
            GemVal _t2370[] = {gem_v__for_items_59};
            if (!gem_truthy(gem_lt(gem_v__for_i_59, gem_len_fn(NULL, _t2370, 1)))) break;
#line 1386 "compiler/main.gem"
...
#line 1387 "compiler/main.gem"
    GemVal _t2371 = gem_v_ei;
    GemVal _t2372[] = {gem_table_get(_t2371, gem_string("path"))};
            gem_v_out = gem_add(gem_v_out, gem_add(gem_add(gem_string("#include \""), gem_to_string_fn(NULL, _t2372, 1)), gem_string("\"\n")));
        }
    }
...
#line 1392 "compiler/main.gem"
    GemVal _t2373[] = {(*gem_v_forward_decls)};
        GemVal gem_v__for_limit_60 = gem_len_fn(NULL, _t2373, 1);
#line 1392 "compiler/main.gem"
        while (1) {
...
#line 1394 "compiler/main.gem"
    GemVal _t2374[] = {(*gem_v_forward_decls)};
            if (gem_truthy(gem_lt(gem_v_i, gem_sub(gem_len_fn(NULL, _t2374, 1), gem_int(1))))) {
...
#line 1401 "compiler/main.gem"
    GemVal _t2375[] = {(*gem_v_functions)};
        GemVal gem_v__for_limit_61 = gem_len_fn(NULL, _t2375, 1);
#line 1401 "compiler/main.gem"
        while (1) {
...
#line 1403 "compiler/main.gem"
    GemVal _t2376[] = {(*gem_v_functions)};
            if (gem_truthy(gem_lt(gem_v_i, gem_sub(gem_len_fn(NULL, _t2376, 1), gem_int(1))))) {
...
#line 459 "compiler/main.gem"
    struct _closure__anon_30 *_t1373 = GC_MALLOC(sizeof(struct _closure__anon_30));
    _t1373->gem_v_boxed_vars = gem_v_boxed_vars;
    _t1373->gem_v_compile_anon_fn = gem_v_compile_anon_fn;
    _t1373->gem_v_compile_array = gem_v_compile_array;
    _t1373->gem_v_compile_binop = gem_v_compile_binop;
    _t1373->gem_v_compile_call = gem_v_compile_call;
    _t1373->gem_v_compile_expr = gem_v_compile_expr;
    _t1373->gem_v_compile_table = gem_v_compile_table;
    _t1373->gem_v_defined_fns = gem_v_defined_fns;
    _t1373->gem_v_mangle = gem_v_mangle;
    _t1373->gem_v_tmp = gem_v_tmp;
    *gem_v_compile_expr = gem_make_fn(_anon_30, _t1373);
#line 562 "compiler/main.gem"
    struct _closure__anon_31 *_t1390 = GC_MALLOC(sizeof(struct _closure__anon_31));
    _t1390->gem_v_compile_expr = gem_v_compile_expr;
    _t1390->gem_v_tmp = gem_v_tmp;
    *gem_v_compile_table = gem_make_fn(_anon_31, _t1390);
#line 577 "compiler/main.gem"
    struct _closure__anon_32 *_t1404 = GC_MALLOC(sizeof(struct _closure__anon_32));
    _t1404->gem_v_compile_expr = gem_v_compile_expr;
    _t1404->gem_v_tmp = gem_v_tmp;
    *gem_v_compile_array = gem_make_fn(_anon_32, _t1404);
#line 591 "compiler/main.gem"
    struct _closure__anon_33 *_t1442 = GC_MALLOC(sizeof(struct _closure__anon_33));
    _t1442->gem_v_boxed_vars = gem_v_boxed_vars;
    _t1442->gem_v_collect_free_vars = gem_v_collect_free_vars;
    _t1442->gem_v_compile_closure_fn = gem_v_compile_closure_fn;
    _t1442->gem_v_mangle = gem_v_mangle;
    _t1442->gem_v_tmp = gem_v_tmp;
    *gem_v_compile_anon_fn = gem_make_fn(_anon_33, _t1442);
#line 619 "compiler/main.gem"
    struct _closure__anon_34 *_t1557 = GC_MALLOC(sizeof(struct _closure__anon_34));
    _t1557->gem_v_compile_expr = gem_v_compile_expr;
    _t1557->gem_v_defined_fns = gem_v_defined_fns;
    _t1557->gem_v_source_name = gem_v_source_name;
    _t1557->gem_v_tmp = gem_v_tmp;
    *gem_v_compile_call = gem_make_fn(_anon_34, _t1557);
#line 745 "compiler/main.gem"
    struct _closure__anon_35 *_t1701 = GC_MALLOC(sizeof(struct _closure__anon_35));
    _t1701->gem_v_compile_expr = gem_v_compile_expr;
    _t1701->gem_v_tmp = gem_v_tmp;
    *gem_v_compile_binop = gem_make_fn(_anon_35, _t1701);
#line 820 "compiler/main.gem"
    struct _closure__anon_36 *_t1706 = GC_MALLOC(sizeof(struct _closure__anon_36));
    _t1706->gem_v_compile_stmt = gem_v_compile_stmt;
    *gem_v_compile_stmts = gem_make_fn(_anon_36, _t1706);
#line 830 "compiler/main.gem"
    struct _closure__anon_37 *_t1866 = GC_MALLOC(sizeof(struct _closure__anon_37));
    _t1866->gem_v_boxed_vars = gem_v_boxed_vars;
    _t1866->gem_v_compile_expr = gem_v_compile_expr;
    _t1866->gem_v_compile_if = gem_v_compile_if;
    _t1866->gem_v_compile_match = gem_v_compile_match;
    _t1866->gem_v_compile_stmt = gem_v_compile_stmt;
    _t1866->gem_v_compile_while = gem_v_compile_while;
    _t1866->gem_v_mangle = gem_v_mangle;
    _t1866->gem_v_source_name = gem_v_source_name;
    _t1866->gem_v_tmp = gem_v_tmp;
    *gem_v_compile_stmt = gem_make_fn(_anon_37, _t1866);
#line 901 "compiler/main.gem"
    struct _closure__anon_38 *_t2013 = GC_MALLOC(sizeof(struct _closure__anon_38));
    _t2013->gem_v_boxed_vars = gem_v_boxed_vars;
    _t2013->gem_v_compile_expr = gem_v_compile_expr;
    _t2013->gem_v_compile_if_return = gem_v_compile_if_return;
    _t2013->gem_v_compile_match_return = gem_v_compile_match_return;
    _t2013->gem_v_compile_stmt = gem_v_compile_stmt;
    _t2013->gem_v_compile_stmt_return = gem_v_compile_stmt_return;
    _t2013->gem_v_compile_while = gem_v_compile_while;
    _t2013->gem_v_mangle = gem_v_mangle;
    _t2013->gem_v_source_name = gem_v_source_name;
    _t2013->gem_v_tmp = gem_v_tmp;
    *gem_v_compile_stmt_return = gem_make_fn(_anon_38, _t2013);
#line 960 "compiler/main.gem"
    struct _closure__anon_39 *_t2029 = GC_MALLOC(sizeof(struct _closure__anon_39));
    _t2029->gem_v_compile_expr = gem_v_compile_expr;
    _t2029->gem_v_compile_stmts = gem_v_compile_stmts;
    *gem_v_compile_if = gem_make_fn(_anon_39, _t2029);
#line 976 "compiler/main.gem"
    struct _closure__anon_40 *_t2062 = GC_MALLOC(sizeof(struct _closure__anon_40));
    _t2062->gem_v_compile_expr = gem_v_compile_expr;
    _t2062->gem_v_compile_stmt = gem_v_compile_stmt;
    _t2062->gem_v_compile_stmt_return = gem_v_compile_stmt_return;
    *gem_v_compile_if_return = gem_make_fn(_anon_40, _t2062);
#line 1011 "compiler/main.gem"
    struct _closure__anon_41 *_t2080 = GC_MALLOC(sizeof(struct _closure__anon_41));
    _t2080->gem_v_compile_expr = gem_v_compile_expr;
    _t2080->gem_v_compile_stmts = gem_v_compile_stmts;
    *gem_v_compile_while = gem_make_fn(_anon_41, _t2080);
#line 1026 "compiler/main.gem"
    struct _closure__anon_42 *_t2111 = GC_MALLOC(sizeof(struct _closure__anon_42));
    _t2111->gem_v_compile_expr = gem_v_compile_expr;
    _t2111->gem_v_compile_stmts = gem_v_compile_stmts;
    _t2111->gem_v_tmp = gem_v_tmp;
    *gem_v_compile_match = gem_make_fn(_anon_42, _t2111);
#line 1053 "compiler/main.gem"
    struct _closure__anon_43 *_t2159 = GC_MALLOC(sizeof(struct _closure__anon_43));
    _t2159->gem_v_compile_expr = gem_v_compile_expr;
    _t2159->gem_v_compile_stmt = gem_v_compile_stmt;
    _t2159->gem_v_compile_stmt_return = gem_v_compile_stmt_return;
    _t2159->gem_v_tmp = gem_v_tmp;
    *gem_v_compile_match_return = gem_make_fn(_anon_43, _t2159);
#line 1099 "compiler/main.gem"
    struct _closure__anon_44 *_t2204 = GC_MALLOC(sizeof(struct _closure__anon_44));
    _t2204->gem_v_forward_decls = gem_v_forward_decls;
    *gem_v_compile_extern_fn = gem_make_fn(_anon_44, _t2204);
#line 1178 "compiler/main.gem"
    struct _closure__anon_45 *_t2262 = GC_MALLOC(sizeof(struct _closure__anon_45));
    _t2262->gem_v_boxed_vars = gem_v_boxed_vars;
    _t2262->gem_v_compile_stmt = gem_v_compile_stmt;
    _t2262->gem_v_compile_stmt_return = gem_v_compile_stmt_return;
    _t2262->gem_v_find_captured_in_scope = gem_v_find_captured_in_scope;
    _t2262->gem_v_mangle = gem_v_mangle;
    _t2262->gem_v_source_name = gem_v_source_name;
    *gem_v_compile_fn = gem_make_fn(_anon_45, _t2262);
#line 1243 "compiler/main.gem"
    struct _closure__anon_46 *_t2330 = GC_MALLOC(sizeof(struct _closure__anon_46));
    _t2330->gem_v_anon_name = gem_v_anon_name;
    _t2330->gem_v_boxed_vars = gem_v_boxed_vars;
    _t2330->gem_v_compile_stmt = gem_v_compile_stmt;
    _t2330->gem_v_compile_stmt_return = gem_v_compile_stmt_return;
    _t2330->gem_v_find_captured_in_scope = gem_v_find_captured_in_scope;
    _t2330->gem_v_functions = gem_v_functions;
    _t2330->gem_v_mangle = gem_v_mangle;
    _t2330->gem_v_source_name = gem_v_source_name;
    *gem_v_compile_closure_fn = gem_make_fn(_anon_46, _t2330);
#line 1318 "compiler/main.gem"
    struct _closure__anon_47 *_t2378 = GC_MALLOC(sizeof(struct _closure__anon_47));
    _t2378->gem_v_boxed_vars = gem_v_boxed_vars;
    _t2378->gem_v_compile_extern_fn = gem_v_compile_extern_fn;
    _t2378->gem_v_compile_fn = gem_v_compile_fn;
    _t2378->gem_v_compile_stmts = gem_v_compile_stmts;
    _t2378->gem_v_defined_fns = gem_v_defined_fns;
    _t2378->gem_v_find_captured_in_scope = gem_v_find_captured_in_scope;
    _t2378->gem_v_forward_decls = gem_v_forward_decls;
    _t2378->gem_v_functions = gem_v_functions;
    _t2378->gem_v_source_name = gem_v_source_name;
    GemVal gem_v_compile = gem_make_fn(_anon_47, _t2378);
    GemVal _t2379 = gem_table_new();
    gem_table_set(_t2379, gem_string("compile"), gem_v_compile);
    GemVal _t2380 = _t2379;
    gem_pop_frame();
    return _t2380;
}
...
#line 1418 "compiler/main.gem"
    ...
    gem_push_frame("split_string", "compiler/main.gem", 1418);
#line 1419 "compiler/main.gem"
    GemVal _t2381 = gem_table_new();
    GemVal gem_v_result = _t2381;
...
#line 1421 "compiler/main.gem"
    GemVal _t2382[] = {gem_v_s};
        GemVal gem_v__for_limit_62 = gem_len_fn(NULL, _t2382, 1);
#line 1421 "compiler/main.gem"
        while (1) {
...
#line 1423 "compiler/main.gem"
    GemVal _t2383[] = {gem_v_result, gem_v_current};
...
#line 1429 "compiler/main.gem"
    GemVal _t2384[] = {gem_v_result, gem_v_current};
...
#line 1436 "compiler/main.gem"
    ...
    gem_push_frame("str_replace", "compiler/main.gem", 1436);
#line 1437 "compiler/main.gem"
    GemVal gem_v_result = gem_string("");
#line 1438 "compiler/main.gem"
    GemVal gem_v_i = gem_int(0);
#line 1439 "compiler/main.gem"
    GemVal _t2386[] = {gem_v_old};
    GemVal gem_v_old_len = gem_len_fn(NULL, _t2386, 1);
#line 1440 "compiler/main.gem"
    GemVal _t2387[] = {gem_v_s};
    GemVal gem_v_s_len = gem_len_fn(NULL, _t2387, 1);
...
#line 20 "compiler/main.gem"
    ...
    GemVal gem_v_new_stmts = _t2389;
#line 21 "compiler/main.gem"
    GemVal gem_v_count = gem_int(0);
    {
#line 22 "compiler/main.gem"
    GemVal _t2390 = gem_v_ast;
        GemVal gem_v__for_items_1 = gem_table_get(_t2390, gem_string("stmts"));
#line 22 "compiler/main.gem"
        GemVal gem_v__for_i_1 = gem_int(0);
#line 22 "compiler/main.gem"
        while (1) {
            GemVal _t2391[] = {gem_v__for_items_1};
            if (!gem_truthy(gem_lt(gem_v__for_i_1, gem_len_fn(NULL, _t2391, 1)))) break;
#line 22 "compiler/main.gem"
...
#line 23 "compiler/main.gem"
    ...
    GemVal _t2394;
    if (!gem_truthy(gem_eq(gem_type_fn(NULL, _t2392, 1), gem_string("table")))) {
        _t2394 = gem_eq(gem_type_fn(NULL, _t2392, 1), gem_string("table"));
    } else {
        GemVal _t2393 = gem_v_stmt;
        _t2394 = gem_eq(gem_table_get(_t2393, gem_string("tag")), gem_string("load"));
    }
            if (gem_truthy(_t2394)) {
#line 24 "compiler/main.gem"
    GemVal _t2395 = gem_v_stmt;
                GemVal gem_v_path = gem_table_get(_t2395, gem_string("path"));
#line 26 "compiler/main.gem"
    GemVal _t2396[] = {gem_v_path};
    GemVal _t2404;
    if (gem_truthy(gem_lt(gem_len_fn(NULL, _t2396, 1), gem_int(4)))) {
        _t2404 = gem_lt(gem_len_fn(NULL, _t2396, 1), gem_int(4));
    } else {
        GemVal _t2397[] = {gem_v_path};
        GemVal _t2399;
        if (gem_truthy(gem_neq(gem_table_get(gem_v_path, gem_sub(gem_len_fn(NULL, _t2397, 1), gem_int(4))), gem_string(".")))) {
                _t2399 = gem_neq(gem_table_get(gem_v_path, gem_sub(gem_len_fn(NULL, _t2397, 1), gem_int(4))), gem_string("."));
        } else {
                GemVal _t2398[] = {gem_v_path};
                _t2399 = gem_neq(gem_table_get(gem_v_path, gem_sub(gem_len_fn(NULL, _t2398, 1), gem_int(3))), gem_string("g"));
        }
        GemVal _t2401;
        if (gem_truthy(_t2399)) {
                ...
                _t2401 = gem_neq(gem_table_get(gem_v_path, gem_sub(gem_len_fn(NULL, _t2400, 1), gem_int(2))), gem_string("e"));
        }
        GemVal _t2403;
        if (gem_truthy(_t2401)) {
                _t2403 = _t2401;
        } else {
                GemVal _t2402[] = {gem_v_path};
                _t2403 = gem_neq(gem_table_get(gem_v_path, gem_sub(gem_len_fn(NULL, _t2402, 1), gem_int(1))), gem_string("m"));
        }
        _t2404 = _t2403;
    }
...
#line 29 "compiler/main.gem"
    GemVal _t2405[] = {gem_v_base_dir, gem_v_path};
    GemVal _t2406[] = {gem_fn_gem_path_join(NULL, _t2405, 2)};
                GemVal gem_v_full_path = gem_fn_gem_normalize_path(NULL, _t2406, 1);
#line 32 "compiler/main.gem"
...
#line 37 "compiler/main.gem"
    GemVal _t2407[] = {gem_v_full_path};
                GemVal gem_v_source = gem_fn_gem_read_file(NULL, _t2407, 1);
#line 38 "compiler/main.gem"
                if (gem_truthy(gem_eq(gem_v_source, gem_string("")))) {
#line 39 "compiler/main.gem"
    GemVal _t2408[] = {gem_v_full_path};
    GemVal _t2409[] = {gem_add(gem_add(gem_string("cannot load '"), gem_to_string_fn(NULL, _t2408, 1)), gem_string("'"))};
                    (void)(gem_error_at_fn("compiler/main.gem", 39, _t2409, 1));
                }
#line 42 "compiler/main.gem"
    GemVal _t2410[] = {gem_v_source};
                GemVal gem_v_loaded_ast = gem_fn_parse_source(NULL, _t2410, 1);
#line 43 "compiler/main.gem"
    GemVal _t2411[] = {gem_v_full_path};
                GemVal gem_v_loaded_dir = gem_fn_gem_dirname(NULL, _t2411, 1);
#line 44 "compiler/main.gem"
    GemVal _t2412[] = {gem_v_loaded_ast, gem_v_loaded_dir, gem_v_loaded};
                GemVal gem_v_resolved = gem_fn_resolve_loads(NULL, _t2412, 3);
                {
#line 46 "compiler/main.gem"
    GemVal _t2413 = gem_v_resolved;
                    GemVal gem_v__for_items_2 = gem_table_get(_t2413, gem_string("stmts"));
#line 46 "compiler/main.gem"
                    GemVal gem_v__for_i_2 = gem_int(0);
#line 46 "compiler/main.gem"
                    while (1) {
                        GemVal _t2414[] = {gem_v__for_items_2};
                        if (!gem_truthy(gem_lt(gem_v__for_i_2, gem_len_fn(NULL, _t2414, 1)))) break;
#line 46 "compiler/main.gem"
...
#line 55 "compiler/main.gem"
    GemVal _t2415[] = {gem_v_new_stmts};
    GemVal _t2416 = gem_fn_make_program(NULL, _t2415, 1);
    gem_pop_frame();
    return _t2416;
}
...
#line 62 "compiler/main.gem"
    GemVal _t2417[] = {gem_string("usage: gem_compiler <file.gem>")};
        (void)(gem_error_at_fn("compiler/main.gem", 62, _t2417, 1));
    }
#line 65 "compiler/main.gem"
    GemVal _t2418[] = {gem_int(1)};
    GemVal gem_v_src_path = gem_fn_gem_get_argv(NULL, _t2418, 1);
#line 66 "compiler/main.gem"
    GemVal _t2419[] = {gem_v_src_path};
    GemVal gem_v_source = gem_fn_gem_read_file(NULL, _t2419, 1);
#line 67 "compiler/main.gem"
    if (gem_truthy(gem_eq(gem_v_source, gem_string("")))) {
#line 68 "compiler/main.gem"
    GemVal _t2420[] = {gem_v_src_path};
    GemVal _t2421[] = {gem_add(gem_add(gem_string("cannot read '"), gem_to_string_fn(NULL, _t2420, 1)), gem_string("'"))};
        (void)(gem_error_at_fn("compiler/main.gem", 68, _t2421, 1));
    }
#line 71 "compiler/main.gem"
    GemVal _t2422[] = {gem_v_source};
    GemVal gem_v_ast = gem_fn_parse_source(NULL, _t2422, 1);
#line 72 "compiler/main.gem"
    GemVal _t2423[] = {gem_v_src_path};
    GemVal gem_v_base_dir = gem_fn_gem_dirname(NULL, _t2423, 1);
#line 73 "compiler/main.gem"
    GemVal _t2424 = gem_table_new();
    GemVal gem_v_loaded = _t2424;
#line 74 "compiler/main.gem"
    GemVal _t2425[] = {gem_v_ast, gem_v_base_dir, gem_v_loaded};
    GemVal gem_v_resolved_ast = gem_fn_resolve_loads(NULL, _t2425, 3);
#line 76 "compiler/main.gem"
    GemVal _t2426[] = {gem_v_src_path};
    GemVal gem_v_cg = gem_fn_make_codegen(NULL, _t2426, 1);
#line 77 "compiler/main.gem"
    GemVal _t2427 = gem_v_cg;
    GemVal _t2428 = gem_table_get(_t2427, gem_string("compile"));
    GemVal _t2429[] = {gem_v_resolved_ast};
    GemVal gem_v_c_code = _t2428.fn(_t2428.env, _t2429, 1);
#line 78 "compiler/main.gem"
    GemVal _t2430[] = {gem_v_c_code};
    (void)(gem_fn_puts(NULL, _t2430, 1));
    gem_pop_frame();
    return 0;
}
