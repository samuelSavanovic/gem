...
#line 654 "compiler/main.gem"
    ...
    GemVal _t2237[] = {gem_add(gem_string("unknown unary operator: "), gem_to_string_fn(NULL, _t2236, 1))};
        (void)(gem_error_at_fn("compiler/main.gem", 654, _t2237, 1));
    } else {
...
#line 673 "compiler/main.gem"
    ...
    GemVal _t2302 = gem_error_at_fn("compiler/main.gem", 673, _t2301, 1);
    gem_pop_frame();
    return _t2302;
}
...
#line 890 "compiler/main.gem"
    ...
    GemVal _t2639 = gem_error_at_fn("compiler/main.gem", 890, _t2638, 1);
    gem_pop_frame();
    return _t2639;
}
...
#line 130 "compiler/main.gem"
    ...
    gem_table_set(_t1528, gem_string("band"), gem_string("gem_band_fn"));
    gem_table_set(_t1528, gem_string("bor"), gem_string("gem_bor_fn"));
    gem_table_set(_t1528, gem_string("bxor"), gem_string("gem_bxor_fn"));
    gem_table_set(_t1528, gem_string("bnot"), gem_string("gem_bnot_fn"));
    gem_table_set(_t1528, gem_string("bshl"), gem_string("gem_bshl_fn"));
    gem_table_set(_t1528, gem_string("bshr"), gem_string("gem_bshr_fn"));
