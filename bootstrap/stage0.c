...
#line 667 "compiler/main.gem"
    ...
    GemVal _t2283[] = {gem_add(gem_string("unknown unary operator: "), gem_to_string_fn(NULL, _t2282, 1))};
        (void)(gem_error_at_fn("compiler/main.gem", 667, _t2283, 1));
    } else {
...
#line 686 "compiler/main.gem"
    ...
    GemVal _t2348 = gem_error_at_fn("compiler/main.gem", 686, _t2347, 1);
    gem_pop_frame();
    return _t2348;
}
...
#line 907 "compiler/main.gem"
    ...
    GemVal _t2718 = gem_error_at_fn("compiler/main.gem", 907, _t2717, 1);
    gem_pop_frame();
    return _t2718;
}
...
#line 1978 "compiler/main.gem"
    ...
    gem_push_frame("str_replace", "compiler/main.gem", 1978);
...
#line 68 "compiler/main.gem"
    ...
    gem_table_set(_t4211, gem_string("src_path"), GEM_NIL);
    gem_table_set(_t4211, gem_string("out_name"), GEM_NIL);
    gem_table_set(_t4211, gem_string("emit_c"), gem_bool(0));
    gem_table_set(_t4211, gem_string("run"), gem_bool(0));
    GemVal _t4212 = gem_table_new();
    gem_table_set(_t4211, gem_string("run_args"), _t4212);
    GemVal gem_v_result = _t4211;
#line 76 "compiler/main.gem"
    GemVal _t4213[] = {gem_v_args};
    GemVal gem_v_argc = gem_len_fn(NULL, _t4213, 1);
#line 77 "compiler/main.gem"
...
#line 84 "compiler/main.gem"
    GemVal _t4214 = gem_v_result;
            gem_table_set(gem_table_get(_t4214, gem_string("run_args")), gem_v_run_arg_count, gem_v_arg);
#line 85 "compiler/main.gem"
...
#line 94 "compiler/main.gem"
    GemVal _t4215[] = {gem_string("gem: -o requires an argument")};
                            (void)(gem_error_at_fn("compiler/main.gem", 94, _t4215, 1));
                        }
#line 96 "compiler/main.gem"
                        gem_table_set(gem_v_result, gem_string("out_name"), gem_table_get(gem_v_args, gem_v_i));
                    } else {
#line 97 "compiler/main.gem"
    GemVal _t4216 = gem_v_result;
                        if (gem_truthy(gem_eq(gem_table_get(_t4216, gem_string("src_path")), GEM_NIL))) {
#line 98 "compiler/main.gem"
                            gem_table_set(gem_v_result, gem_string("src_path"), gem_v_arg);
                        } else {
#line 101 "compiler/main.gem"
    GemVal _t4217 = gem_v_result;
                            gem_table_set(gem_table_get(_t4217, gem_string("run_args")), gem_v_run_arg_count, gem_v_arg);
#line 102 "compiler/main.gem"
                            gem_v_run_arg_count = gem_add(gem_v_run_arg_count, gem_int(1));
                        }
                    }
...
#line 114 "compiler/main.gem"
    GemVal _t4219[] = {gem_v_path};
    GemVal gem_v_plen = gem_len_fn(NULL, _t4219, 1);
#line 115 "compiler/main.gem"
...
#line 118 "compiler/main.gem"
    GemVal _t4220[] = {gem_v_path, gem_v_i};
        if (gem_truthy(gem_eq(gem_ord_fn(NULL, _t4220, 2), gem_int(47)))) {
#line 119 "compiler/main.gem"
...
#line 123 "compiler/main.gem"
    GemVal _t4221[] = {gem_v_path, gem_add(gem_v_last_slash, gem_int(1)), gem_sub(gem_sub(gem_v_plen, gem_v_last_slash), gem_int(1))};
    GemVal gem_v_name = gem_substr_fn(NULL, _t4221, 3);
#line 125 "compiler/main.gem"
    GemVal _t4222[] = {gem_v_name};
    GemVal gem_v_nlen = gem_len_fn(NULL, _t4222, 1);
#line 126 "compiler/main.gem"
    if (gem_truthy(gem_gt(gem_v_nlen, gem_int(4)))) {
#line 127 "compiler/main.gem"
    GemVal _t4223[] = {gem_v_name, gem_sub(gem_v_nlen, gem_int(4)), gem_int(4)};
        GemVal gem_v_maybe_ext = gem_substr_fn(NULL, _t4223, 3);
#line 128 "compiler/main.gem"
        if (gem_truthy(gem_eq(gem_v_maybe_ext, gem_string(".gem")))) {
#line 129 "compiler/main.gem"
    GemVal _t4224[] = {gem_v_name, gem_int(0), gem_sub(gem_v_nlen, gem_int(4))};
            gem_v_name = gem_substr_fn(NULL, _t4224, 3);
        }
    }
    GemVal _t4225 = gem_v_name;
    gem_pop_frame();
    return _t4225;
}
...
#line 178 "compiler/main.gem"
    ...
    gem_table_set(_t4226, gem_string("split"), gem_make_fn(gem_fn__string_split, NULL));
    gem_table_set(_t4226, gem_string("index_of"), gem_make_fn(gem_fn__string_index_of, NULL));
    gem_table_set(_t4226, gem_string("join"), gem_make_fn(gem_fn__string_join, NULL));
    gem_table_set(_t4226, gem_string("trim"), gem_make_fn(gem_fn__string_trim, NULL));
    gem_table_set(_t4226, gem_string("starts_with"), gem_make_fn(gem_fn__string_starts_with, NULL));
    gem_table_set(_t4226, gem_string("ends_with"), gem_make_fn(gem_fn__string_ends_with, NULL));
    gem_table_set(_t4226, gem_string("upper"), gem_make_fn(gem_fn__string_upper, NULL));
    gem_table_set(_t4226, gem_string("lower"), gem_make_fn(gem_fn__string_lower, NULL));
    gem_table_set(_t4226, gem_string("contains"), gem_make_fn(gem_fn__string_contains, NULL));
    gem_table_set(_t4226, gem_string("repeat"), gem_make_fn(gem_fn__string_repeat, NULL));
    gem_v_string = _t4226;
#line 16 "compiler/main.gem"
    GemVal _t4227[] = {gem_table_get(gem_argv_fn(NULL, NULL, 0), gem_int(0))};
    GemVal _t4228[] = {gem_dirname_fn(NULL, _t4227, 1)};
    gem_v_install_root = gem_dirname_fn(NULL, _t4228, 1);
#line 137 "compiler/main.gem"
    GemVal _t4229[] = {gem_argv_fn(NULL, NULL, 0)};
    gem_v_argc = gem_len_fn(NULL, _t4229, 1);
#line 138 "compiler/main.gem"
    if (gem_truthy(gem_lt(gem_v_argc, gem_int(2)))) {
#line 139 "compiler/main.gem"
    GemVal _t4230[] = {gem_string("usage: gem <file.gem> [--emit-c | --run | -o <name>]")};
        (void)(gem_error_at_fn("compiler/main.gem", 139, _t4230, 1));
    }
#line 142 "compiler/main.gem"
    GemVal _t4231[] = {gem_argv_fn(NULL, NULL, 0)};
    gem_v_cli = gem_fn_parse_args(NULL, _t4231, 1);
#line 144 "compiler/main.gem"
    GemVal _t4232 = gem_v_cli;
    if (gem_truthy(gem_eq(gem_table_get(_t4232, gem_string("src_path")), GEM_NIL))) {
#line 145 "compiler/main.gem"
    GemVal _t4233[] = {gem_string("usage: gem <file.gem> [--emit-c | --run | -o <name>]")};
        (void)(gem_error_at_fn("compiler/main.gem", 145, _t4233, 1));
    }
#line 148 "compiler/main.gem"
    GemVal _t4234 = gem_v_cli;
    gem_v_src_path = gem_table_get(_t4234, gem_string("src_path"));
#line 149 "compiler/main.gem"
    GemVal _t4235[] = {gem_v_src_path};
    gem_v_source = gem_read_file_fn(NULL, _t4235, 1);
#line 151 "compiler/main.gem"
    GemVal _t4236[] = {gem_v_source, gem_v_src_path};
    gem_v_ast = gem_fn_parse_source(NULL, _t4236, 2);
#line 152 "compiler/main.gem"
    GemVal _t4237[] = {gem_v_src_path};
    gem_v_base_dir = gem_dirname_fn(NULL, _t4237, 1);
#line 153 "compiler/main.gem"
    GemVal _t4238 = gem_table_new();
    gem_v_loaded = _t4238;
#line 154 "compiler/main.gem"
    GemVal _t4239[] = {gem_v_ast, gem_v_base_dir, gem_v_loaded};
    gem_v_resolved_ast = gem_fn_resolve_loads(NULL, _t4239, 3);
#line 156 "compiler/main.gem"
    GemVal _t4240[] = {gem_v_src_path};
    gem_v_cg = gem_fn_make_codegen(NULL, _t4240, 1);
#line 157 "compiler/main.gem"
    GemVal _t4241 = gem_v_cg;
    GemVal _t4242[] = {gem_v_resolved_ast};
    GemVal _t4243 = gem_table_get(_t4241, gem_string("compile"));
    gem_v_c_code = _t4243.fn(_t4243.env, _t4242, 1);
#line 161 "compiler/main.gem"
    GemVal _t4244 = gem_v_cli;
    if (gem_truthy(gem_table_get(_t4244, gem_string("emit_c")))) {
#line 162 "compiler/main.gem"
    GemVal _t4245[] = {gem_v_c_code};
        (void)(gem_print(NULL, _t4245, 1));
    } else {
#line 166 "compiler/main.gem"
    GemVal _t4246[] = {gem_v_src_path};
        GemVal gem_v_base = gem_fn_basename_no_ext(NULL, _t4246, 1);
#line 167 "compiler/main.gem"
        GemVal gem_v_tmp_c = gem_add(gem_add(gem_string("/tmp/gem_"), gem_v_base), gem_string(".c"));
#line 170 "compiler/main.gem"
    GemVal _t4247 = gem_v_cli;
        GemVal gem_v_out_name = gem_table_get(_t4247, gem_string("out_name"));
#line 171 "compiler/main.gem"
...
#line 176 "compiler/main.gem"
    GemVal _t4248[] = {gem_v_tmp_c, gem_v_c_code};
        (void)(gem_write_file_fn(NULL, _t4248, 2));
#line 179 "compiler/main.gem"
    GemVal _t4249[] = {gem_v_install_root, gem_string("runtime")};
        GemVal gem_v_runtime_dir = gem_path_join_fn(NULL, _t4249, 2);
#line 182 "compiler/main.gem"
        GemVal gem_v_gc_flags = gem_string("-lgc");
#line 183 "compiler/main.gem"
    GemVal _t4250[] = {gem_string("pkg-config --cflags --libs bdw-gc > /tmp/gem_gc_flags.txt 2>/dev/null")};
        GemVal gem_v_pkg_ret = gem_exec_fn(NULL, _t4250, 1);
#line 184 "compiler/main.gem"
        if (gem_truthy(gem_eq(gem_v_pkg_ret, gem_int(0)))) {
#line 185 "compiler/main.gem"
    GemVal _t4251[] = {gem_string("/tmp/gem_gc_flags.txt")};
            gem_v_gc_flags = gem_read_file_fn(NULL, _t4251, 1);
#line 187 "compiler/main.gem"
    GemVal _t4252[] = {gem_v_gc_flags, gem_string("\n"), gem_string("")};
            gem_v_gc_flags = gem_str_replace_fn(NULL, _t4252, 3);
        }
#line 190 "compiler/main.gem"
...
#line 192 "compiler/main.gem"
    GemVal _t4253[] = {gem_v_cc_cmd};
        GemVal gem_v_cc_ret = gem_exec_fn(NULL, _t4253, 1);
#line 193 "compiler/main.gem"
        if (gem_truthy(gem_neq(gem_v_cc_ret, gem_int(0)))) {
#line 194 "compiler/main.gem"
    GemVal _t4254[] = {gem_v_cc_ret};
    GemVal _t4255[] = {gem_add(gem_add(gem_string("gem: compilation failed (cc exited with "), gem_to_string_fn(NULL, _t4254, 1)), gem_string(")"))};
            (void)(gem_error_at_fn("compiler/main.gem", 194, _t4255, 1));
        }
#line 199 "compiler/main.gem"
    GemVal _t4256 = gem_v_cli;
        if (gem_truthy(gem_table_get(_t4256, gem_string("run")))) {
...
#line 202 "compiler/main.gem"
            while (1) {
                gem_yield_check();
                GemVal _t4257 = gem_v_cli;
                GemVal _t4258[] = {gem_table_get(_t4257, gem_string("run_args"))};
                if (!gem_truthy(gem_lt(gem_v_i, gem_len_fn(NULL, _t4258, 1)))) break;
#line 203 "compiler/main.gem"
    GemVal _t4259 = gem_v_cli;
                gem_v_run_cmd = gem_add(gem_add(gem_v_run_cmd, gem_string(" ")), gem_table_get(gem_table_get(_t4259, gem_string("run_args")), gem_v_i));
#line 204 "compiler/main.gem"
                gem_v_i = gem_add(gem_v_i, gem_int(1));
            }
#line 206 "compiler/main.gem"
    GemVal _t4260[] = {gem_v_run_cmd};
            GemVal gem_v_run_ret = gem_exec_fn(NULL, _t4260, 1);
#line 207 "compiler/main.gem"
            if (gem_truthy(gem_neq(gem_v_run_ret, gem_int(0)))) {
#line 208 "compiler/main.gem"
    GemVal _t4261[] = {gem_v_run_ret};
                (void)(gem_exit_process_fn(NULL, _t4261, 1));
            }
        }
    }
    gem_run_scheduler();
