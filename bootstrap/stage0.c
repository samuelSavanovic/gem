...
#line 639 "compiler/main.gem"
    ...
    GemVal _t2235[] = {gem_add(gem_string("unknown unary operator: "), gem_to_string_fn(NULL, _t2234, 1))};
        (void)(gem_error_at_fn("compiler/main.gem", 639, _t2235, 1));
    } else {
...
#line 658 "compiler/main.gem"
    ...
    GemVal _t2300 = gem_error_at_fn("compiler/main.gem", 658, _t2299, 1);
    gem_pop_frame();
    return _t2300;
}
...
#line 875 "compiler/main.gem"
    ...
    GemVal _t2632 = gem_error_at_fn("compiler/main.gem", 875, _t2631, 1);
    gem_pop_frame();
    return _t2632;
}
...
#line 51 "compiler/main.gem"
    GemVal _t3841[] = {gem_v_full_path};
            GemVal gem_v_source = gem_fn_gem_read_file(NULL, _t3841, 1);
#line 52 "compiler/main.gem"
            if (gem_truthy(gem_eq(gem_v_source, gem_string("")))) {
#line 53 "compiler/main.gem"
    GemVal _t3842[] = {gem_v_full_path};
    GemVal _t3843[] = {gem_add(gem_add(gem_string("cannot load '"), gem_to_string_fn(NULL, _t3842, 1)), gem_string("'"))};
                (void)(gem_error_at_fn("compiler/main.gem", 53, _t3843, 1));
            }
#line 56 "compiler/main.gem"
    GemVal _t3844[] = {gem_v_source, gem_v_full_path};
            GemVal gem_v_loaded_ast = gem_fn_parse_source(NULL, _t3844, 2);
#line 57 "compiler/main.gem"
    GemVal _t3845[] = {gem_v_full_path};
            GemVal gem_v_loaded_dir = gem_fn_gem_dirname(NULL, _t3845, 1);
#line 58 "compiler/main.gem"
    GemVal _t3846[] = {gem_v_loaded_ast, gem_v_loaded_dir, gem_v_loaded};
            GemVal gem_v_resolved = gem_fn_resolve_loads(NULL, _t3846, 3);
#line 60 "compiler/main.gem"
    GemVal _t3847 = gem_v_resolved;
            GemVal gem_v__for_items_2 = gem_table_get(_t3847, gem_string("stmts"));
#line 60 "compiler/main.gem"
            GemVal gem_v__for_i_2 = gem_int(0);
#line 60 "compiler/main.gem"
            while (1) {
                gem_yield_check();
                GemVal _t3848[] = {gem_v__for_items_2};
                if (!gem_truthy(gem_lt(gem_v__for_i_2, gem_len_fn(NULL, _t3848, 1)))) break;
#line 60 "compiler/main.gem"
...
#line 69 "compiler/main.gem"
    GemVal _t3849[] = {gem_v_new_stmts};
    GemVal _t3850 = gem_fn_make_program(NULL, _t3849, 1);
    gem_pop_frame();
    return _t3850;
}
...
#line 20 "compiler/main.gem"
    GemVal _t3851[] = {gem_int(0)};
    GemVal _t3852[] = {gem_fn_gem_get_argv(NULL, _t3851, 1)};
    GemVal _t3853[] = {gem_fn_gem_dirname(NULL, _t3852, 1)};
    gem_v_install_root = gem_fn_gem_dirname(NULL, _t3853, 1);
#line 74 "compiler/main.gem"
    gem_v_argc = gem_fn_gem_get_argc(NULL, NULL, 0);
#line 75 "compiler/main.gem"
    if (gem_truthy(gem_lt(gem_v_argc, gem_int(2)))) {
#line 76 "compiler/main.gem"
    GemVal _t3854[] = {gem_string("usage: gem_compiler <file.gem>")};
        (void)(gem_error_at_fn("compiler/main.gem", 76, _t3854, 1));
    }
#line 79 "compiler/main.gem"
    GemVal _t3855[] = {gem_int(1)};
    gem_v_src_path = gem_fn_gem_get_argv(NULL, _t3855, 1);
#line 80 "compiler/main.gem"
    GemVal _t3856[] = {gem_v_src_path};
    gem_v_source = gem_fn_gem_read_file(NULL, _t3856, 1);
#line 81 "compiler/main.gem"
    if (gem_truthy(gem_eq(gem_v_source, gem_string("")))) {
#line 82 "compiler/main.gem"
    GemVal _t3857[] = {gem_v_src_path};
    GemVal _t3858[] = {gem_add(gem_add(gem_string("cannot read '"), gem_to_string_fn(NULL, _t3857, 1)), gem_string("'"))};
        (void)(gem_error_at_fn("compiler/main.gem", 82, _t3858, 1));
    }
#line 85 "compiler/main.gem"
    GemVal _t3859[] = {gem_v_source, gem_v_src_path};
    gem_v_ast = gem_fn_parse_source(NULL, _t3859, 2);
#line 86 "compiler/main.gem"
    GemVal _t3860[] = {gem_v_src_path};
    gem_v_base_dir = gem_fn_gem_dirname(NULL, _t3860, 1);
#line 87 "compiler/main.gem"
    GemVal _t3861 = gem_table_new();
    gem_v_loaded = _t3861;
#line 88 "compiler/main.gem"
    GemVal _t3862[] = {gem_v_ast, gem_v_base_dir, gem_v_loaded};
    gem_v_resolved_ast = gem_fn_resolve_loads(NULL, _t3862, 3);
#line 90 "compiler/main.gem"
    GemVal _t3863[] = {gem_v_src_path};
    gem_v_cg = gem_fn_make_codegen(NULL, _t3863, 1);
#line 91 "compiler/main.gem"
    GemVal _t3864 = gem_v_cg;
    GemVal _t3865[] = {gem_v_resolved_ast};
    GemVal _t3866 = gem_table_get(_t3864, gem_string("compile"));
    gem_v_c_code = _t3866.fn(_t3866.env, _t3865, 1);
#line 92 "compiler/main.gem"
    GemVal _t3867[] = {gem_v_c_code};
    (void)(gem_fn_puts(NULL, _t3867, 1));
    gem_run_scheduler();
    gem_pop_frame();
    return 0;
}
