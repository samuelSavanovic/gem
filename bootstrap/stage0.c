...
#line 766 "compiler/main.gem"
    ...
    GemVal _t2411[] = {gem_add(gem_string("unknown unary operator: "), gem_to_string_fn(NULL, _t2410, 1))};
        (void)(gem_error_at_fn("compiler/main.gem", 766, _t2411, 1));
    } else {
...
#line 785 "compiler/main.gem"
    ...
    GemVal _t2476 = gem_error_at_fn("compiler/main.gem", 785, _t2475, 1);
    gem_pop_frame();
    return _t2476;
}
...
#line 1006 "compiler/main.gem"
    ...
    GemVal _t2846 = gem_error_at_fn("compiler/main.gem", 1006, _t2845, 1);
    gem_pop_frame();
    return _t2846;
}
...
#line 134 "compiler/main.gem"
    ...
    gem_table_set(_t1611, gem_string("tcp_connect"), gem_string("gem_tcp_connect_fn"));
    gem_table_set(_t1611, gem_string("tcp_listen"), gem_string("gem_tcp_listen_fn"));
    gem_table_set(_t1611, gem_string("tcp_accept"), gem_string("gem_tcp_accept_fn"));
    gem_table_set(_t1611, gem_string("tcp_read"), gem_string("gem_tcp_read_fn"));
    gem_table_set(_t1611, gem_string("tcp_write"), gem_string("gem_tcp_write_fn"));
    gem_table_set(_t1611, gem_string("tcp_close"), gem_string("gem_tcp_close_fn"));
