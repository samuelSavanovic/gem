...
#line 641 "compiler/main.gem"
    ...
    GemVal _t2235[] = {gem_add(gem_string("unknown unary operator: "), gem_to_string_fn(NULL, _t2234, 1))};
        (void)(gem_error_at_fn("compiler/main.gem", 641, _t2235, 1));
    } else {
...
#line 660 "compiler/main.gem"
    ...
    GemVal _t2300 = gem_error_at_fn("compiler/main.gem", 660, _t2299, 1);
    gem_pop_frame();
    return _t2300;
}
...
#line 877 "compiler/main.gem"
    ...
    GemVal _t2632 = gem_error_at_fn("compiler/main.gem", 877, _t2631, 1);
    gem_pop_frame();
    return _t2632;
}
...
#line 1896 "compiler/main.gem"
    ...
    gem_push_frame("str_replace", "compiler/main.gem", 1896);
