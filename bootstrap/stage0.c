...
#line 636 "compiler/main.gem"
    ...
    GemVal _t2201[] = {gem_add(gem_string("unknown unary operator: "), gem_to_string_fn(NULL, _t2200, 1))};
        (void)(gem_error_at_fn("compiler/main.gem", 636, _t2201, 1));
    } else {
...
#line 655 "compiler/main.gem"
    ...
    GemVal _t2266 = gem_error_at_fn("compiler/main.gem", 655, _t2265, 1);
    gem_pop_frame();
    return _t2266;
}
...
#line 872 "compiler/main.gem"
    ...
    GemVal _t2598 = gem_error_at_fn("compiler/main.gem", 872, _t2597, 1);
    gem_pop_frame();
    return _t2598;
}
...
#line 1888 "compiler/main.gem"
    ...
    gem_push_frame("str_replace", "compiler/main.gem", 1888);
