...
#line 777 "compiler/main.gem"
    ...
    GemVal _t2657[] = {gem_interp(2, _t2656)};
        (void)(gem_error_at_fn("compiler/main.gem", 777, _t2657, 1));
    } else {
...
#line 798 "compiler/main.gem"
    ...
    GemVal _t2719 = gem_error_at_fn("compiler/main.gem", 798, _t2718, 1);
    gem_pop_frame();
    return _t2719;
}
...
#line 1050 "compiler/main.gem"
    ...
    GemVal _t3063 = gem_error_at_fn("compiler/main.gem", 1050, _t3062, 1);
    gem_pop_frame();
    return _t3063;
}
...
#line 134 "compiler/main.gem"
    ...
    gem_table_set(_t1858, gem_string("build_string"), gem_string("gem_build_string_fn"));
